...
import "github.com/ddkwork/librarygo/src/cpp2go/delete/myc2go/windef"
...
var (
	...
	IOCTL_GET_DETAIL_OF_ACTIVE_THREADS_AND_PROCESSES           = CTL_CODE(FILE_DEVICE_UNKNOWN, 0x819, METHOD_BUFFERED, FILE_ANY_ACCESS)
	IOCTL_GET_LIST_OF_THREADS_AND_PROCESSES                    = CTL_CODE(FILE_DEVICE_UNKNOWN, 0x81c, METHOD_BUFFERED, FILE_ANY_ACCESS)
	IOCTL_GET_USER_MODE_MODULE_DETAILS                         = CTL_CODE(FILE_DEVICE_UNKNOWN, 0x81a, METHOD_BUFFERED, FILE_ANY_ACCESS)
	IOCTL_PAUSE_PACKET_RECEIVED                                = CTL_CODE(FILE_DEVICE_UNKNOWN, 0x811, METHOD_BUFFERED, FILE_ANY_ACCESS)
	IOCTL_PERFROM_KERNEL_SIDE_TESTS                            = CTL_CODE(FILE_DEVICE_UNKNOWN, 0x816, METHOD_BUFFERED, FILE_ANY_ACCESS)
	IOCTL_PREPARE_DEBUGGEE                                     = CTL_CODE(FILE_DEVICE_UNKNOWN, 0x810, METHOD_BUFFERED, FILE_ANY_ACCESS)
	IOCTL_QUERY_COUNT_OF_ACTIVE_PROCESSES_OR_THREADS           = CTL_CODE(FILE_DEVICE_UNKNOWN, 0x81b, METHOD_BUFFERED, FILE_ANY_ACCESS)
	IOCTL_QUERY_CURRENT_PROCESS                                = CTL_CODE(FILE_DEVICE_UNKNOWN, 0x81d, METHOD_BUFFERED, FILE_ANY_ACCESS)
	IOCTL_QUERY_CURRENT_THREAD                                 = CTL_CODE(FILE_DEVICE_UNKNOWN, 0x81e, METHOD_BUFFERED, FILE_ANY_ACCESS)
	IOCTL_REGISTER_EVENT                                       = CTL_CODE(FILE_DEVICE_UNKNOWN, 0x800, METHOD_BUFFERED, FILE_ANY_ACCESS)
	IOCTL_RESERVE_PRE_ALLOCATED_POOLS                          = CTL_CODE(FILE_DEVICE_UNKNOWN, 0x817, METHOD_BUFFERED, FILE_ANY_ACCESS)
	...
	IOCTL_SEND_GET_KERNEL_SIDE_TEST_INFORMATION                = CTL_CODE(FILE_DEVICE_UNKNOWN, 0x815, METHOD_BUFFERED, FILE_ANY_ACCESS)
	...
	IOCTL_SEND_USER_DEBUGGER_COMMANDS                          = CTL_CODE(FILE_DEVICE_UNKNOWN, 0x818, METHOD_BUFFERED, FILE_ANY_ACCESS)
