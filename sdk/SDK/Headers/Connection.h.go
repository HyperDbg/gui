...
//todo this syntax is a bug,need fix
//const (
//	// Debuggee to debugger
//	DEBUGGER_REMOTE_PACKET_REQUESTED_ACTION_NO_ACTION DEBUGGER_REMOTE_PACKET_REQUESTED_ACTION_DEBUGGEE_RESULT DEBUGGER_REMOTE_PACKET_REQUESTED_ACTION = iota
...
type (
	DEBUGGER_REMOTE_PACKET struct {
		Checksum                   byte
		Indicator                  uint64
		TypeOfThePacket            DEBUGGER_REMOTE_PACKET_REQUESTED_ACTION //todo wrong type, rename and merge them
