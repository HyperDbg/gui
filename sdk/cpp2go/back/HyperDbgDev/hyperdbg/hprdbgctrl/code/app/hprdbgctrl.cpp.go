package app
//back\HyperDbgDev\hyperdbg\hprdbgctrl\code\app\hprdbgctrl.cpp.back

type (
Hprdbgctrl interface{
HyperdbgSetTextMessageCallback()(ok bool)//col:4
ShowMessages()(ok bool)//col:43
ReadIrpBasedBuffer()(ok bool)//col:232
ThreadFunc()(ok bool)//col:237
HyperDbgInstallVmmDriver()(ok bool)//col:251
HyperdbgStopDriver()(ok bool)//col:263
HyperDbgStopVmmDriver()(ok bool)//col:267
HyperdbgUninstallDriver()(ok bool)//col:279
HyperDbgUninstallVmmDriver()(ok bool)//col:283
...
func (h *hprdbgctrl)ShowMessages()(ok bool){//col:43
...
func (h *hprdbgctrl)ReadIrpBasedBuffer()(ok bool){//col:232
/*ReadIrpBasedBuffer()
{
    BOOL                   Status;
...
func (h *hprdbgctrl)ThreadFunc()(ok bool){//col:237
...
func (h *hprdbgctrl)HyperDbgInstallVmmDriver()(ok bool){//col:251
...
func (h *hprdbgctrl)HyperdbgStopDriver()(ok bool){//col:263
...
func (h *hprdbgctrl)HyperDbgStopVmmDriver()(ok bool){//col:267
...
func (h *hprdbgctrl)HyperdbgUninstallDriver()(ok bool){//col:279
...
func (h *hprdbgctrl)HyperDbgUninstallVmmDriver()(ok bool){//col:283
...
func (h *hprdbgctrl)HyperDbgLoadVmm()(ok bool){//col:351
/*HyperDbgLoadVmm()
{
    string CpuID;
    DWORD  ErrorNum;
...
func (h *hprdbgctrl)HyperDbgUnloadVmm()(ok bool){//col:399
/*HyperDbgUnloadVmm()
{
    BOOL Status;
