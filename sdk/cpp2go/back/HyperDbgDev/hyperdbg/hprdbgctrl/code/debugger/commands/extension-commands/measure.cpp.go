...
//back\HyperDbgDev\hyperdbg\hprdbgctrl\code\debugger\commands\extension-commands\measure.cpp.back

type (
Measure interface{
CommandMeasureHelp()(ok bool)//col:43
CommandMeasure()(ok bool)//col:148
}
)
...
func (m *measure)CommandMeasure()(ok bool){//col:148
