...
//back\HyperDbgDev\hyperdbg\hprdbgctrl\code\debugger\commands\extension-commands\crwrite.cpp.back

type (
Crwrite interface{
CommandCrwriteHelp()(ok bool)//col:33
CommandCrwrite()(ok bool)//col:199
}
)
...
func (c *crwrite)CommandCrwrite()(ok bool){//col:199
