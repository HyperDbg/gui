...
const(
WIN32_LEAN_AND_MEAN =  //col:1
)

type (
Tcpserver interface{
CommunicationServerCreateServerAndWaitForClient()(ok bool)//col:70
CommunicationServerReceiveMessage()(ok bool)//col:89
...
func (t *tcpserver)CommunicationServerReceiveMessage()(ok bool){//col:89
...
func (t *tcpserver)CommunicationServerSendMessage()(ok bool){//col:99
...
func (t *tcpserver)CommunicationServerShutdownAndCleanupConnection()(ok bool){//col:115
