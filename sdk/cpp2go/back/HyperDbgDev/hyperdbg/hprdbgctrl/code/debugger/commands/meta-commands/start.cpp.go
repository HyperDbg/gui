...
//back\HyperDbgDev\hyperdbg\hprdbgctrl\code\debugger\commands\meta-commands\start.cpp.back

type (
Start interface{
CommandStartHelp()(ok bool)//col:35
CommandStart()(ok bool)//col:159
}
)
...
func (s *start)CommandStart()(ok bool){//col:159
