...
//back\HyperDbgDev\hyperdbg\hprdbgctrl\code\debugger\commands\meta-commands\disconnect.cpp.back

type (
Disconnect interface{
CommandDisconnectHelp()(ok bool)//col:34
CommandDisconnect()(ok bool)//col:97
}
)
...
func (d *disconnect)CommandDisconnect()(ok bool){//col:97
