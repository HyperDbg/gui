...
//back\HyperDbgDev\hyperdbg\hprdbgctrl\code\debugger\commands\meta-commands\listen.cpp.back

type (
Listen interface{
CommandListenHelp()(ok bool)//col:43
CommandListen()(ok bool)//col:122
}
)
...
func (l *listen)CommandListen()(ok bool){//col:122
