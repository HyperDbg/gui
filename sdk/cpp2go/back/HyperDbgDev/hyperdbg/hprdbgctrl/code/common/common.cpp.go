...
PrintBits()(ok bool)//col:63
Replace()(ok bool)//col:82
ReplaceAll()(ok bool)//col:110
Split()(ok bool)//col:140
IsNumber()(ok bool)//col:158
IsHexNotation()(ok bool)//col:186
IsDecimalNotation()(ok bool)//col:214
HexToBytes()(ok bool)//col:236
ConvertStringToUInt64()(ok bool)//col:346
ConvertStringToUInt32()(ok bool)//col:446
HasEnding()(ok bool)//col:471
ValidateIP()(ok bool)//col:508
VmxSupportDetection()(ok bool)//col:524
        ShowMessages()(ok bool)//col:576
ltrim()(ok bool)//col:588
rtrim()(ok bool)//col:602
Trim()(ok bool)//col:615
RemoveSpaces()(ok bool)//col:628
IsFileExistA()(ok bool)//col:642
IsFileExistW()(ok bool)//col:656
IsEmptyString()(ok bool)//col:684
GetConfigFilePath()(ok bool)//col:711
ListDirectory()(ok bool)//col:742
StringToWString()(ok bool)//col:758
SplitPathAndArgs()(ok bool)//col:831
FindCaseInsensitive()(ok bool)//col:851
FindCaseInsensitiveW()(ok bool)//col:871
ConvertStringVectorToCharPointerArray()(ok bool)//col:891
GetCpuid()(ok bool)//col:906
Getx86VirtualAddressWidth()(ok bool)//col:925
CheckCpuSupportRtm()(ok bool)//col:961
CheckCanonicalVirtualAddress()(ok bool)//col:1020
CheckIfAddressIsValidUsingTsx()(ok bool)//col:1061
