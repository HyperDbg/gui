package code
//back\HyperDbgDev\hyperdbg\symbol-parser\code\symbol-parser.cpp.back

type (
SymbolParser interface{
SymSetTextMessageCallback()(ok bool)//col:5
ShowMessages()(ok bool)//col:27
SymGetModuleBaseFromSearchMask()(ok bool)//col:80
SymGetFieldOffsetFromModule()(ok bool)//col:132
SymGetDataTypeSizeFromModule()(ok bool)//col:150
SymLoadFileSymbol()(ok bool)//col:232
SymUnloadModuleSymbol()(ok bool)//col:263
SymUnloadAllSymbols()(ok bool)//col:285
SymConvertNameToAddress()(ok bool)//col:316
SymGetFieldOffset()(ok bool)//col:349
SymGetDataTypeSize()(ok bool)//col:377
SymSearchSymbolForMask()(ok bool)//col:400
SymCreateSymbolTableForDisassembler()(ok bool)//col:422
SymSeparateTo64BitValue()(ok bool)//col:431
SymGetFileParams()(ok bool)//col:453
SymGetFileSize()(ok bool)//col:476
SymShowSymbolInfo()(ok bool)//col:548
SymDisplayMaskSymbolsCallback()(ok bool)//col:556
SymDeliverDisassemblerSymbolMapCallback()(ok bool)//col:564
SymShowSymbolDetails()(ok bool)//col:580
SymTagStr()(ok bool)//col:651
SymConvertFileToPdbPath()(ok bool)//col:684
SymConvertFileToPdbFileAndGuidAndAgeDetails()(ok bool)//col:717
SymbolInitLoad()(ok bool)//col:814
SymbolPDBDownload()(ok bool)//col:857
...
func (s *symbolParser)ShowMessages()(ok bool){//col:27
...
func (s *symbolParser)SymGetModuleBaseFromSearchMask()(ok bool){//col:80
...
func (s *symbolParser)SymGetFieldOffsetFromModule()(ok bool){//col:132
...
func (s *symbolParser)SymGetDataTypeSizeFromModule()(ok bool){//col:150
...
func (s *symbolParser)SymLoadFileSymbol()(ok bool){//col:232
...
func (s *symbolParser)SymUnloadModuleSymbol()(ok bool){//col:263
...
func (s *symbolParser)SymUnloadAllSymbols()(ok bool){//col:285
/*SymUnloadAllSymbols()
{
    BOOL Ret = FALSE;
    for (auto item : g_LoadedModules)
...
func (s *symbolParser)SymConvertNameToAddress()(ok bool){//col:316
...
func (s *symbolParser)SymGetFieldOffset()(ok bool){//col:349
...
func (s *symbolParser)SymGetDataTypeSize()(ok bool){//col:377
...
func (s *symbolParser)SymSearchSymbolForMask()(ok bool){//col:400
...
func (s *symbolParser)SymCreateSymbolTableForDisassembler()(ok bool){//col:422
...
func (s *symbolParser)SymSeparateTo64BitValue()(ok bool){//col:431
...
func (s *symbolParser)SymGetFileParams()(ok bool){//col:453
...
func (s *symbolParser)SymGetFileSize()(ok bool){//col:476
...
func (s *symbolParser)SymShowSymbolInfo()(ok bool){//col:548
...
func (s *symbolParser)SymDisplayMaskSymbolsCallback()(ok bool){//col:556
...
func (s *symbolParser)SymDeliverDisassemblerSymbolMapCallback()(ok bool){//col:564
...
func (s *symbolParser)SymShowSymbolDetails()(ok bool){//col:580
...
func (s *symbolParser)SymTagStr()(ok bool){//col:651
/*SymTagStr(ULONG Tag)
{
    switch (Tag)
    {
...
func (s *symbolParser)SymConvertFileToPdbPath()(ok bool){//col:684
...
func (s *symbolParser)SymConvertFileToPdbFileAndGuidAndAgeDetails()(ok bool){//col:717
...
func (s *symbolParser)SymbolInitLoad()(ok bool){//col:814
...
func (s *symbolParser)SymbolPDBDownload()(ok bool){//col:857
...
func (s *symbolParser)SymbolAbortLoading()(ok bool){//col:865
/*SymbolAbortLoading()
{
    if (!g_AbortLoadingExecution)
    {
...
func (s *symbolParser)SymShowDataBasedOnSymbolTypes()(ok bool){//col:918
