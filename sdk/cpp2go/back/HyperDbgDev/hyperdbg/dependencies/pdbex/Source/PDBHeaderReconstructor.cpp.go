...
PDBHeaderReconstructor::Clear()(ok bool)//col:20
PDBHeaderReconstructor::GetCorrectedSymbolName()(ok bool)//col:46
PDBHeaderReconstructor::OnEnumType()(ok bool)//col:59
PDBHeaderReconstructor::OnEnumTypeBegin()(ok bool)//col:72
PDBHeaderReconstructor::OnEnumTypeEnd()(ok bool)//col:85
PDBHeaderReconstructor::OnEnumField()(ok bool)//col:94
PDBHeaderReconstructor::OnUdt()(ok bool)//col:123
PDBHeaderReconstructor::OnUdtBegin()(ok bool)//col:160
PDBHeaderReconstructor::OnUdtEnd()(ok bool)//col:202
	if_()(ok bool)//col:207
PDBHeaderReconstructor::OnUdtFieldBegin()(ok bool)//col:220
PDBHeaderReconstructor::OnUdtFieldEnd()(ok bool)//col:226
PDBHeaderReconstructor::OnUdtField()(ok bool)//col:329
PDBHeaderReconstructor::OnAnonymousUdtBegin()(ok bool)//col:350
PDBHeaderReconstructor::OnAnonymousUdtEnd()(ok bool)//col:385
PDBHeaderReconstructor::OnUdtFieldBitFieldBegin()(ok bool)//col:412
PDBHeaderReconstructor::OnUdtFieldBitFieldEnd()(ok bool)//col:437
PDBHeaderReconstructor::OnPaddingMember()(ok bool)//col:472
PDBHeaderReconstructor::OnPaddingBitFieldField()(ok bool)//col:519
PDBHeaderReconstructor::Write()(ok bool)//col:589
PDBHeaderReconstructor::WriteUnnamedDataType()(ok bool)//col:614
PDBHeaderReconstructor::WriteTypedefBegin()(ok bool)//col:625
PDBHeaderReconstructor::WriteTypedefEnd()(ok bool)//col:663
PDBHeaderReconstructor::WriteOffset()(ok bool)//col:684
PDBHeaderReconstructor::HasBeenVisited()(ok bool)//col:691
PDBHeaderReconstructor::MarkAsVisited()(ok bool)//col:698
PDBHeaderReconstructor::GetParentOffset()(ok bool)//col:702
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::Clear()(ok bool){//col:20
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::GetCorrectedSymbolName()(ok bool){//col:46
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::OnEnumType()(ok bool){//col:59
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::OnEnumTypeBegin()(ok bool){//col:72
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::OnEnumTypeEnd()(ok bool){//col:85
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::OnEnumField()(ok bool){//col:94
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::OnUdt()(ok bool){//col:123
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::OnUdtBegin()(ok bool){//col:160
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::OnUdtEnd()(ok bool){//col:202
...
func (p *pdbHeaderReconstructor)	if_()(ok bool){//col:207
/*	if (m_Depth == 0)
	{
		Write("\n\n");
	}
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::OnUdtFieldBegin()(ok bool){//col:220
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::OnUdtFieldEnd()(ok bool){//col:226
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::OnUdtField()(ok bool){//col:329
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::OnAnonymousUdtBegin()(ok bool){//col:350
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::OnAnonymousUdtEnd()(ok bool){//col:385
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::OnUdtFieldBitFieldBegin()(ok bool){//col:412
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::OnUdtFieldBitFieldEnd()(ok bool){//col:437
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::OnPaddingMember()(ok bool){//col:472
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::OnPaddingBitFieldField()(ok bool){//col:519
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::Write()(ok bool){//col:589
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::WriteUnnamedDataType()(ok bool){//col:614
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::WriteTypedefBegin()(ok bool){//col:625
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::WriteTypedefEnd()(ok bool){//col:663
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::WriteOffset()(ok bool){//col:684
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::HasBeenVisited()(ok bool){//col:691
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::MarkAsVisited()(ok bool){//col:698
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::GetParentOffset()(ok bool){//col:702
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::AppendToTest()(ok bool){//col:748
...
func (p *pdbHeaderReconstructor)PDBHeaderReconstructor::ShouldExpand()(ok bool){//col:768
