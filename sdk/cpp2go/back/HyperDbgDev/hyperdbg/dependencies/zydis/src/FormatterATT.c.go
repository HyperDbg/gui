package src
//back\HyperDbgDev\hyperdbg\dependencies\zydis\src\FormatterATT.c.back

type (
FormatterAtt interface{
ZyanStatus_ZydisFormatterATTFormatInstruction()(ok bool)//col:131
ZyanStatus_ZydisFormatterATTFormatOperandMEM()(ok bool)//col:187
ZyanStatus_ZydisFormatterATTPrintMnemonic()(ok bool)//col:252
ZyanStatus_ZydisFormatterATTPrintRegister()(ok bool)//col:268
...
func (f *formatterAtt)ZyanStatus_ZydisFormatterATTFormatOperandMEM()(ok bool){//col:187
...
func (f *formatterAtt)ZyanStatus_ZydisFormatterATTPrintMnemonic()(ok bool){//col:252
...
func (f *formatterAtt)ZyanStatus_ZydisFormatterATTPrintRegister()(ok bool){//col:268
...
func (f *formatterAtt)ZyanStatus_ZydisFormatterATTPrintDISP()(ok bool){//col:291
...
func (f *formatterAtt)ZyanStatus_ZydisFormatterATTPrintIMM()(ok bool){//col:300
