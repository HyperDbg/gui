...
type (
Formatter interface{
void_ZydisFormatterBufferInit()(ok bool)//col:15
void_ZydisFormatterBufferInitTokenized()(ok bool)//col:37
ZyanStatus_ZydisFormatterInit()(ok bool)//col:46
ZyanStatus_ZydisFormatterSetProperty()(ok bool)//col:257
ZyanStatus_ZydisFormatterSetHook()(ok bool)//col:319
ZyanStatus_ZydisFormatterFormatInstruction()(ok bool)//col:326
ZyanStatus_ZydisFormatterFormatInstructionEx()(ok bool)//col:352
ZyanStatus_ZydisFormatterFormatOperand()(ok bool)//col:359
ZyanStatus_ZydisFormatterFormatOperandEx()(ok bool)//col:402
ZyanStatus_ZydisFormatterTokenizeInstruction()(ok bool)//col:409
ZyanStatus_ZydisFormatterTokenizeInstructionEx()(ok bool)//col:443
...
func (f *formatter)void_ZydisFormatterBufferInitTokenized()(ok bool){//col:37
...
func (f *formatter)ZyanStatus_ZydisFormatterInit()(ok bool){//col:46
...
func (f *formatter)ZyanStatus_ZydisFormatterSetProperty()(ok bool){//col:257
...
func (f *formatter)ZyanStatus_ZydisFormatterSetHook()(ok bool){//col:319
...
func (f *formatter)ZyanStatus_ZydisFormatterFormatInstruction()(ok bool){//col:326
...
func (f *formatter)ZyanStatus_ZydisFormatterFormatInstructionEx()(ok bool){//col:352
...
func (f *formatter)ZyanStatus_ZydisFormatterFormatOperand()(ok bool){//col:359
...
func (f *formatter)ZyanStatus_ZydisFormatterFormatOperandEx()(ok bool){//col:402
...
func (f *formatter)ZyanStatus_ZydisFormatterTokenizeInstruction()(ok bool){//col:409
...
func (f *formatter)ZyanStatus_ZydisFormatterTokenizeInstructionEx()(ok bool){//col:443
...
func (f *formatter)ZyanStatus_ZydisFormatterTokenizeOperand()(ok bool){//col:450
...
func (f *formatter)ZyanStatus_ZydisFormatterTokenizeOperandEx()(ok bool){//col:501
