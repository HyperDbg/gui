...
const ZydisDecoderTreeNode* ZydisDecoderTreeGetChildNode()(ok bool)//col:161
...
func (d *decoderData)const ZydisDecoderTreeNode* ZydisDecoderTreeGetChildNode()(ok bool){//col:161
