...
const(
    SharedNtdll32LdrInitializeThunk = 1  //col:23
    SharedNtdll32KiUserExceptionDispatcher = 2  //col:24
    SharedNtdll32KiUserApcDispatcher = 3  //col:25
    SharedNtdll32KiUserCallbackDispatcher = 4  //col:26
    SharedNtdll32ExpInterlockedPopEntrySListFault = 5  //col:27
    SharedNtdll32ExpInterlockedPopEntrySListResume = 6  //col:28
    SharedNtdll32ExpInterlockedPopEntrySListEnd = 7  //col:29
    SharedNtdll32RtlUserThreadStart = 8  //col:30
    SharedNtdll32pQueryProcessDebugInformationRemote = 9  //col:31
    SharedNtdll32BaseAddress = 10  //col:32
    SharedNtdll32LdrSystemDllInitBlock = 11  //col:33
    Wow64SharedPageEntriesCount = 12  //col:34
)
...
FORCEINLINE VOID UStrToUStr32()(ok bool)//col:592
}
...
func (n *ntwow64)        WOW64_POINTER()(ok bool){//col:58
...
func (n *ntwow64)    WOW64_POINTER()(ok bool){//col:183
