package out
//back\HyperDbgDev\hyperdbg\dependencies\ia32-doc\out\ia32_defines_only.h.back
...
#defineCpuidEaxSteppingId0x0F #define CPUID_EAX_STEPPING_ID                                        0x0F
model uint32_t
#defineCpuidEaxModel0xF0 #define CPUID_EAX_MODEL                                              0xF0
family_id uint32_t
#defineCpuidEaxFamilyId0xF00 #define CPUID_EAX_FAMILY_ID                                          0xF00
processor_type uint32_t
#defineCpuidEaxProcessorType0x3000 #define CPUID_EAX_PROCESSOR_TYPE                                     0x3000
reserved_1 uint32_t
extended_model_id uint32_t
#defineCpuidEaxExtendedModelId0xF0000 #define CPUID_EAX_EXTENDED_MODEL_ID                                  0xF0000
extended_family_id uint32_t
#defineCpuidEaxExtendedFamilyId0xFf00000 #define CPUID_EAX_EXTENDED_FAMILY_ID                                 0xFF00000
reserved_2 uint32_t
}
...
#defineCpuidEaxCacheTypeField0x1F #define CPUID_EAX_CACHE_TYPE_FIELD                                   0x1F
cache_level uint32_t
#defineCpuidEaxCacheLevel0xE0 #define CPUID_EAX_CACHE_LEVEL                                        0xE0
self_initializing_cache_level uint32_t
#defineCpuidEaxSelfInitializingCacheLevel0x100 #define CPUID_EAX_SELF_INITIALIZING_CACHE_LEVEL                      0x100
fully_associative_cache uint32_t
#defineCpuidEaxFullyAssociativeCache0x200 #define CPUID_EAX_FULLY_ASSOCIATIVE_CACHE                            0x200
reserved_1 uint32_t
max_addressable_ids_for_logical_processors_sharing_this_cache: uint32_t
#defineCpuidEaxMaxAddressableIdsForLogicalProcessorsSharingThisCache0x3Ffc000 #define CPUID_EAX_MAX_ADDRESSABLE_IDS_FOR_LOGICAL_PROCESSORS_SHARING_THIS_CACHE 0x3FFC000
max_addressable_ids_for_processor_cores_in_physical_package: uint32_t
#defineCpuidEaxMaxAddressableIdsForProcessorCoresInPhysicalPackage0xFc000000 #define CPUID_EAX_MAX_ADDRESSABLE_IDS_FOR_PROCESSOR_CORES_IN_PHYSICAL_PACKAGE 0xFC000000
}


type typedef struct { struct{
smallest_monitor_line_size uint32_t
#defineCpuidEaxSmallestMonitorLineSize0xFfff #define CPUID_EAX_SMALLEST_MONITOR_LINE_SIZE                         0xFFFF
reserved_1 uint32_t
}
...
#defineCpuidEaxTemperatureSensorSupported0x01 #define CPUID_EAX_TEMPERATURE_SENSOR_SUPPORTED                       0x01
intel_turbo_boost_technology_available uint32_t
#defineCpuidEaxIntelTurboBoostTechnologyAvailable0x02 #define CPUID_EAX_INTEL_TURBO_BOOST_TECHNOLOGY_AVAILABLE             0x02
apic_timer_always_running uint32_t
#defineCpuidEaxApicTimerAlwaysRunning0x04 #define CPUID_EAX_APIC_TIMER_ALWAYS_RUNNING                          0x04
reserved_1 uint32_t
power_limit_notification uint32_t
#defineCpuidEaxPowerLimitNotification0x10 #define CPUID_EAX_POWER_LIMIT_NOTIFICATION                           0x10
clock_modulation_duty uint32_t
#defineCpuidEaxClockModulationDuty0x20 #define CPUID_EAX_CLOCK_MODULATION_DUTY                              0x20
package_thermal_management uint32_t
#defineCpuidEaxPackageThermalManagement0x40 #define CPUID_EAX_PACKAGE_THERMAL_MANAGEMENT                         0x40
hwp_base_registers uint32_t
#defineCpuidEaxHwpBaseRegisters0x80 #define CPUID_EAX_HWP_BASE_REGISTERS                                 0x80
hwp_notification uint32_t
#defineCpuidEaxHwpNotification0x100 #define CPUID_EAX_HWP_NOTIFICATION                                   0x100
hwp_activity_window uint32_t
#defineCpuidEaxHwpActivityWindow0x200 #define CPUID_EAX_HWP_ACTIVITY_WINDOW                                0x200
hwp_energy_performance_preference uint32_t
#defineCpuidEaxHwpEnergyPerformancePreference0x400 #define CPUID_EAX_HWP_ENERGY_PERFORMANCE_PREFERENCE                  0x400
hwp_package_level_request uint32_t
#defineCpuidEaxHwpPackageLevelRequest0x800 #define CPUID_EAX_HWP_PACKAGE_LEVEL_REQUEST                          0x800
reserved_2 uint32_t
hdc uint32_t
#defineCpuidEaxHdc0x2000 #define CPUID_EAX_HDC                                                0x2000
intel_turbo_boost_max_technology_3_available uint32_t
#defineCpuidEaxIntelTurboBoostMaxTechnology3Available0x4000 #define CPUID_EAX_INTEL_TURBO_BOOST_MAX_TECHNOLOGY_3_AVAILABLE       0x4000
hwp_capabilities uint32_t
#defineCpuidEaxHwpCapabilities0x8000 #define CPUID_EAX_HWP_CAPABILITIES                                   0x8000
hwp_peci_override uint32_t
#defineCpuidEaxHwpPeciOverride0x10000 #define CPUID_EAX_HWP_PECI_OVERRIDE                                  0x10000
flexible_hwp uint32_t
#defineCpuidEaxFlexibleHwp0x20000 #define CPUID_EAX_FLEXIBLE_HWP                                       0x20000
fast_access_mode_for_hwp_request_msr uint32_t
#defineCpuidEaxFastAccessModeForHwpRequestMsr0x40000 #define CPUID_EAX_FAST_ACCESS_MODE_FOR_HWP_REQUEST_MSR               0x40000
reserved_3 uint32_t
ignoring_idle_logical_processor_hwp_request uint32_t
#defineCpuidEaxIgnoringIdleLogicalProcessorHwpRequest0x100000 #define CPUID_EAX_IGNORING_IDLE_LOGICAL_PROCESSOR_HWP_REQUEST        0x100000
reserved_4 uint32_t
intel_thread_director uint32_t
#defineCpuidEaxIntelThreadDirector0x800000 #define CPUID_EAX_INTEL_THREAD_DIRECTOR                              0x800000
reserved_5 uint32_t
}
...
#defineCpuidEaxNumberOfSubLeaves0xFfffffff #define CPUID_EAX_NUMBER_OF_SUB_LEAVES                               0xFFFFFFFF
}


type typedef struct { struct{
ia32_platform_dca_cap uint32_t
#defineCpuidEaxIa32PlatformDcaCap0xFfffffff #define CPUID_EAX_IA32_PLATFORM_DCA_CAP                              0xFFFFFFFF
}


type typedef struct { struct{
version_id_of_architectural_performance_monitoring uint32_t
#defineCpuidEaxVersionIdOfArchitecturalPerformanceMonitoring0xFf #define CPUID_EAX_VERSION_ID_OF_ARCHITECTURAL_PERFORMANCE_MONITORING 0xFF
number_of_performance_monitoring_counter_per_logical_processor: uint32_t
#defineCpuidEaxNumberOfPerformanceMonitoringCounterPerLogicalProcessor0xFf00 #define CPUID_EAX_NUMBER_OF_PERFORMANCE_MONITORING_COUNTER_PER_LOGICAL_PROCESSOR 0xFF00
bit_width_of_performance_monitoring_counter uint32_t
#defineCpuidEaxBitWidthOfPerformanceMonitoringCounter0xFf0000 #define CPUID_EAX_BIT_WIDTH_OF_PERFORMANCE_MONITORING_COUNTER        0xFF0000
ebx_bit_vector_length uint32_t
#defineCpuidEaxEbxBitVectorLength0xFf000000 #define CPUID_EAX_EBX_BIT_VECTOR_LENGTH                              0xFF000000
}


type typedef struct { struct{
x2apic_id_to_unique_topology_id_shift uint32_t
#defineCpuidEaxX2ApicIdToUniqueTopologyIdShift0x1F #define CPUID_EAX_X2APIC_ID_TO_UNIQUE_TOPOLOGY_ID_SHIFT              0x1F
reserved_1 uint32_t
}
...
type typedef struct { struct{
x87_state uint32_t
#defineCpuidEaxX87State0x01 #define CPUID_EAX_X87_STATE                                          0x01
sse_state uint32_t
#defineCpuidEaxSseState0x02 #define CPUID_EAX_SSE_STATE                                          0x02
avx_state uint32_t
#defineCpuidEaxAvxState0x04 #define CPUID_EAX_AVX_STATE                                          0x04
mpx_state uint32_t
#defineCpuidEaxMpxState0x18 #define CPUID_EAX_MPX_STATE                                          0x18
avx_512_state uint32_t
#defineCpuidEaxAvx512State0xE0 #define CPUID_EAX_AVX_512_STATE                                      0xE0
used_for_ia32_xss_1 uint32_t
#defineCpuidEaxUsedForIa32Xss10x100 #define CPUID_EAX_USED_FOR_IA32_XSS_1                                0x100
pkru_state uint32_t
#defineCpuidEaxPkruState0x200 #define CPUID_EAX_PKRU_STATE                                         0x200
reserved_1 uint32_t
used_for_ia32_xss_2 uint32_t
#defineCpuidEaxUsedForIa32Xss20x2000 #define CPUID_EAX_USED_FOR_IA32_XSS_2                                0x2000
reserved_2 uint32_t
}
...
#defineCpuidEaxSupportsXsavecAndCompactedXrstor0x02 #define CPUID_EAX_SUPPORTS_XSAVEC_AND_COMPACTED_XRSTOR               0x02
supports_xgetbv_with_ecx_1 uint32_t
#defineCpuidEaxSupportsXgetbvWithEcx10x04 #define CPUID_EAX_SUPPORTS_XGETBV_WITH_ECX_1                         0x04
supports_xsave_xrstor_and_ia32_xss uint32_t
#defineCpuidEaxSupportsXsaveXrstorAndIa32Xss0x08 #define CPUID_EAX_SUPPORTS_XSAVE_XRSTOR_AND_IA32_XSS                 0x08
reserved_2 uint32_t
}
...
type typedef struct { struct{
reserved uint32_t
#defineCpuidEaxReserved0xFfffffff #define CPUID_EAX_RESERVED                                           0xFFFFFFFF
}
...
#defineCpuidEaxLengthOfCapacityBitMask0x1F #define CPUID_EAX_LENGTH_OF_CAPACITY_BIT_MASK                        0x1F
reserved_1 uint32_t
}
...
#defineCpuidEaxMaxMbaThrottlingValue0xFff #define CPUID_EAX_MAX_MBA_THROTTLING_VALUE                           0xFFF
reserved_1 uint32_t
}
...
type typedef struct { struct{
sgx1 uint32_t
#defineCpuidEaxSgx10x01 #define CPUID_EAX_SGX1                                               0x01
sgx2 uint32_t
#defineCpuidEaxSgx20x02 #define CPUID_EAX_SGX2                                               0x02
reserved_1 uint32_t
sgx_enclv_advanced uint32_t
#defineCpuidEaxSgxEnclvAdvanced0x20 #define CPUID_EAX_SGX_ENCLV_ADVANCED                                 0x20
sgx_encls_advanced uint32_t
#defineCpuidEaxSgxEnclsAdvanced0x40 #define CPUID_EAX_SGX_ENCLS_ADVANCED                                 0x40
reserved_2 uint32_t
}
...
#defineCpuidEaxValidSecsAttributes00xFfffffff #define CPUID_EAX_VALID_SECS_ATTRIBUTES_0                            0xFFFFFFFF
}


type typedef struct { struct{
sub_leaf_type uint32_t
#defineCpuidEaxSubLeafType0x0F #define CPUID_EAX_SUB_LEAF_TYPE                                      0x0F
reserved_1 uint32_t
}
...
#defineCpuidEaxEpcBasePhysicalAddress10xFffff000 #define CPUID_EAX_EPC_BASE_PHYSICAL_ADDRESS_1                        0xFFFFF000
}


type typedef struct { struct{
max_sub_leaf uint32_t
#defineCpuidEaxMaxSubLeaf0xFfffffff #define CPUID_EAX_MAX_SUB_LEAF                                       0xFFFFFFFF
}


type typedef struct { struct{
number_of_configurable_address_ranges_for_filtering uint32_t
#defineCpuidEaxNumberOfConfigurableAddressRangesForFiltering0x07 #define CPUID_EAX_NUMBER_OF_CONFIGURABLE_ADDRESS_RANGES_FOR_FILTERING 0x07
reserved_1 uint32_t
bitmap_of_supported_mtc_period_encodings uint32_t
#defineCpuidEaxBitmapOfSupportedMtcPeriodEncodings0xFfff0000 #define CPUID_EAX_BITMAP_OF_SUPPORTED_MTC_PERIOD_ENCODINGS           0xFFFF0000
}


type typedef struct { struct{
denominator uint32_t
#defineCpuidEaxDenominator0xFfffffff #define CPUID_EAX_DENOMINATOR                                        0xFFFFFFFF
}


type typedef struct { struct{
procesor_base_frequency_mhz uint32_t
#defineCpuidEaxProcesorBaseFrequencyMhz0xFfff #define CPUID_EAX_PROCESOR_BASE_FREQUENCY_MHZ                        0xFFFF
reserved_1 uint32_t
}
...
#defineCpuidEaxMaxSocIdIndex0xFfffffff #define CPUID_EAX_MAX_SOC_ID_INDEX                                   0xFFFFFFFF
}


type typedef struct { struct{
soc_vendor_brand_string uint32_t
#defineCpuidEaxSocVendorBrandString0xFfffffff #define CPUID_EAX_SOC_VENDOR_BRAND_STRING                            0xFFFFFFFF
}
...
#defineCpuidEaxMaxExtendedFunctions0xFfffffff #define CPUID_EAX_MAX_EXTENDED_FUNCTIONS                             0xFFFFFFFF
}
...
#defineCpuidEaxProcessorBrandString10xFfffffff #define CPUID_EAX_PROCESSOR_BRAND_STRING_1                           0xFFFFFFFF
}


type typedef struct { struct{
processor_brand_string_5 uint32_t
#defineCpuidEaxProcessorBrandString50xFfffffff #define CPUID_EAX_PROCESSOR_BRAND_STRING_5                           0xFFFFFFFF
}


type typedef struct { struct{
processor_brand_string_9 uint32_t
#defineCpuidEaxProcessorBrandString90xFfffffff #define CPUID_EAX_PROCESSOR_BRAND_STRING_9                           0xFFFFFFFF
}
...
#defineCpuidEaxNumberOfPhysicalAddressBits0xFf #define CPUID_EAX_NUMBER_OF_PHYSICAL_ADDRESS_BITS                    0xFF
number_of_linear_address_bits uint32_t
#defineCpuidEaxNumberOfLinearAddressBits0xFf00 #define CPUID_EAX_NUMBER_OF_LINEAR_ADDRESS_BITS                      0xFF00
reserved_1 uint32_t
}
...
#defineSegmentBaseAddressMiddle0xFf #define SEGMENT__BASE_ADDRESS_MIDDLE                                 0xFF
type uint32_t
#defineSegmentType0xF00 #define SEGMENT__TYPE                                                0xF00
descriptor_type uint32_t
#defineSegmentDescriptorType0x1000 #define SEGMENT__DESCRIPTOR_TYPE                                     0x1000
descriptor_privilege_level uint32_t
#defineSegmentDescriptorPrivilegeLevel0x6000 #define SEGMENT__DESCRIPTOR_PRIVILEGE_LEVEL                          0x6000
present uint32_t
#defineSegmentPresent0x8000 #define SEGMENT__PRESENT                                             0x8000
segment_limit_high uint32_t
#defineSegmentSegmentLimitHigh0xF0000 #define SEGMENT__SEGMENT_LIMIT_HIGH                                  0xF0000
available_bit uint32_t
#defineSegmentAvailableBit0x100000 #define SEGMENT__AVAILABLE_BIT                                       0x100000
long_mode uint32_t
#defineSegmentLongMode0x200000 #define SEGMENT__LONG_MODE                                           0x200000
default_big uint32_t
#defineSegmentDefaultBig0x400000 #define SEGMENT__DEFAULT_BIG                                         0x400000
granularity uint32_t
#defineSegmentGranularity0x800000 #define SEGMENT__GRANULARITY                                         0x800000
base_address_high uint32_t
#defineSegmentBaseAddressHigh0xFf000000 #define SEGMENT__BASE_ADDRESS_HIGH                                   0xFF000000
}
...
#defineSegmentInterruptStackTable0x07 #define SEGMENT__INTERRUPT_STACK_TABLE                               0x07
must_be_zero_0 uint32_t
#defineSegmentMustBeZero00xF8 #define SEGMENT__MUST_BE_ZERO_0                                      0xF8
type uint32_t
#defineSegmentType0xF00 #define SEGMENT__TYPE                                                0xF00
must_be_zero_1 uint32_t
#defineSegmentMustBeZero10x1000 #define SEGMENT__MUST_BE_ZERO_1                                      0x1000
descriptor_privilege_level uint32_t
#defineSegmentDescriptorPrivilegeLevel0x6000 #define SEGMENT__DESCRIPTOR_PRIVILEGE_LEVEL                          0x6000
present uint32_t
#defineSegmentPresent0x8000 #define SEGMENT__PRESENT                                             0x8000
offset_middle uint32_t
#defineSegmentOffsetMiddle0xFfff0000 #define SEGMENT__OFFSET_MIDDLE                                       0xFFFF0000
}
...
type typedef struct { struct{
present uint64_t
#defineVtdLower64Present0x01 #define VTD_Lower64_PRESENT                                          0x01
reserved_1 uint64_t
context_table_pointer uint64_t
#defineVtdLower64ContextTablePointer0xFffffffffffff000 #define VTD_Lower64_CONTEXT_TABLE_POINTER                            0xFFFFFFFFFFFFF000
}
...
#defineVtdLower64FaultProcessingDisable0x02 #define VTD_Lower64_FAULT_PROCESSING_DISABLE                         0x02
translation_type uint64_t
#defineVtdLower64TranslationType0x0C #define VTD_Lower64_TRANSLATION_TYPE                                 0x0C
reserved_1 uint64_t
second_level_page_translation_pointer uint64_t
#defineVtdLower64SecondLevelPageTranslationPointer0xFffffffffffff000 #define VTD_Lower64_SECOND_LEVEL_PAGE_TRANSLATION_POINTER            0xFFFFFFFFFFFFF000
}
 ...
 *           IA32_P5_MC_()(ok bool)//col:2466
 *           IA32_SGXLEPUBKEYHASH[()(ok bool)//col:2587
 *           IA32_PMC()(ok bool)//col:2623
 *           IA32_PERFEVTSEL()(ok bool)//col:2799
 *           IA32_MTRR_PHYSBASE()(ok bool)//col:3141
 *           IA32_MTRR_PHYSMASK()(ok bool)//col:3173
 *           IA32_MTRR_FIX()(ok bool)//col:3275
 *           IA32_MC()(ok bool)//col:3325
 *           IA32_FIXED_CTR()(ok bool)//col:3378
 *           IA32_MC()(ok bool)//col:3726
 *           IA32_VMX_TRUE_()(ok bool)//col:4086
 *           IA32_A_PMC()(ok bool)//col:4156
 *           IA32_RTIT_ADDR()(ok bool)//col:4333
 *           IA32_X2APIC_ISR()(ok bool)//col:4580
 *           64-Bit ()(ok bool)//col:4918
 ...
 *           VMCS ()(ok bool)//col:6409
 *           Advanced Programmable Interrupt Controller ()(ok bool)//col:6908
}
)
...
func (i *ia32DefinesOnly) *           IA32_P5_MC_()(ok bool){//col:2466
/* *           IA32_P5_MC_(x)
...
func (i *ia32DefinesOnly) *           IA32_SGXLEPUBKEYHASH[()(ok bool){//col:2587
...
func (i *ia32DefinesOnly) *           IA32_PMC()(ok bool){//col:2623
/* *           IA32_PMC(n)
...
func (i *ia32DefinesOnly) *           IA32_PERFEVTSEL()(ok bool){//col:2799
/* *           IA32_PERFEVTSEL(n)
...
func (i *ia32DefinesOnly) *           IA32_MTRR_PHYSBASE()(ok bool){//col:3141
...
func (i *ia32DefinesOnly) *           IA32_MTRR_PHYSMASK()(ok bool){//col:3173
...
func (i *ia32DefinesOnly) *           IA32_MTRR_FIX()(ok bool){//col:3275
/* *           IA32_MTRR_FIX(x)
 *           IA32_MTRR_FIX64K(x)
...
func (i *ia32DefinesOnly) *           IA32_MC()(ok bool){//col:3325
/* *           IA32_MC(i)_CTL2
...
func (i *ia32DefinesOnly) *           IA32_FIXED_CTR()(ok bool){//col:3378
/* *           IA32_FIXED_CTR(n)
...
func (i *ia32DefinesOnly) *           IA32_MC()(ok bool){//col:3726
/* *           IA32_MC(i)_CTL
...
func (i *ia32DefinesOnly) *           IA32_VMX_TRUE_()(ok bool){//col:4086
...
func (i *ia32DefinesOnly) *           IA32_A_PMC()(ok bool){//col:4156
/* *           IA32_A_PMC(n)
...
func (i *ia32DefinesOnly) *           IA32_RTIT_ADDR()(ok bool){//col:4333
/* *           IA32_RTIT_ADDR(x)
 *           IA32_RTIT_ADDR(n)_A
...
func (i *ia32DefinesOnly) *           IA32_X2APIC_ISR()(ok bool){//col:4580
/* *           IA32_X2APIC_ISR(n)
...
func (i *ia32DefinesOnly) *           64-Bit ()(ok bool){//col:4918
...
func (i *ia32DefinesOnly) *           VMCS ()(ok bool){//col:6409
...
func (i *ia32DefinesOnly) *           Advanced Programmable Interrupt Controller ()(ok bool){//col:6908
