package code
//back\HyperDbgDev\hyperdbg\script-engine\code\scanner.c.back

type (
Scanner interface{
GetToken()(ok bool)//col:677
Scan()(ok bool)//col:729
sgetc()(ok bool)//col:742
IsKeyword()(ok bool)//col:762
...
func (s *scanner)Scan()(ok bool){//col:729
...
func (s *scanner)sgetc()(ok bool){//col:742
/*sgetc(char * str)
{
    char c = str[InputIdx];
    if (c)
...
func (s *scanner)IsKeyword()(ok bool){//col:762
/*IsKeyword(char * str)
{
...
func (s *scanner)IsRegister()(ok bool){//col:768
/*IsRegister(char * str)
{
...
func (s *scanner)IsId()(ok bool){//col:772
/*IsId(char * str)
{
    return 0;
}*/
