package kdserial
//back\HyperDbgDev\hyperdbg\kdserial\msm8x60.c.back
...
type (
Msm8x60 interface{
Copyright ()(ok bool)//col:319
MSM8x60SetBaud()(ok bool)//col:414
MSM8x60GetByte()(ok bool)//col:537
MSM8x60PutByte()(ok bool)//col:596
MSM8x60RxReady()(ok bool)//col:633
}
)

func NewMsm8x60() { return & msm8x60{} }

func (m *msm8x60)Copyright ()(ok bool){//col:319
...
func (m *msm8x60)MSM8x60SetBaud()(ok bool){//col:414
/*MSM8x60SetBaud(
    _Inout_ PCPPORT Port,
    ULONG           Rate)
Routine Description:
...
func (m *msm8x60)MSM8x60GetByte()(ok bool){//col:537
/*MSM8x60GetByte(
    _Inout_ PCPPORT Port,
    _Out_ PUCHAR    Byte)
Routine Description:
...
func (m *msm8x60)MSM8x60PutByte()(ok bool){//col:596
/*MSM8x60PutByte(
    _Inout_ PCPPORT Port,
    UCHAR           Byte,
    BOOLEAN         BusyWait)
...
func (m *msm8x60)MSM8x60RxReady()(ok bool){//col:633
/*MSM8x60RxReady(
    _Inout_ PCPPORT Port)
Routine Description:
