...
TestKernelConfigureTagsAndCallTargetFunction()(ok bool)//col:26
...
func (k *kernelTests)TestKernelPerformTests()(ok bool){//col:44
/*TestKernelPerformTests(PDEBUGGER_PERFORM_KERNEL_TESTS KernelTestRequest)
{
    ...
    TempPool = TestKernelConfigureTagsAndCallTargetFunction(1,                     
                                                            2,                     
...
func (k *kernelTests)TestKernelGetInformation()(ok bool){//col:64
