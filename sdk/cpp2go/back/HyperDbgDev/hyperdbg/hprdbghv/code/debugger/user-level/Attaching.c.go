...
type (
Attaching interface{
AttachingInitialize()(ok bool)//col:33
AttachingCreateProcessDebuggingDetails()(ok bool)//col:63
AttachingFindProcessDebuggingDetailsByToken()(ok bool)//col:74
AttachingFindProcessDebuggingDetailsByProcessId()(ok bool)//col:85
AttachingFindProcessDebuggingDetailsInStartingPhase()(ok bool)//col:96
AttachingRemoveAndFreeAllProcessDebuggingDetails()(ok bool)//col:105
AttachingRemoveProcessDebuggingDetailsByToken()(ok bool)//col:118
AttachingSetStartingPhaseOfProcessDebuggingDetailsByToken()(ok bool)//col:134
AttachingReachedToProcessEntrypoint()(ok bool)//col:152
AttachingHandleEntrypointDebugBreak()(ok bool)//col:200
AttachingAdjustNopSledBuffer()(ok bool)//col:224
AttachingCheckPageFaultsWithUserDebugger()(ok bool)//col:252
AttachingConfigureInterceptingThreads()(ok bool)//col:297
AttachingPerformAttachToProcess()(ok bool)//col:405
AttachingHandleCr3VmexitsForThreadInterception()(ok bool)//col:433
AttachingRemoveHooks()(ok bool)//col:463
AttachingPauseProcess()(ok bool)//col:476
AttachingKillProcess()(ok bool)//col:508
AttachingPerformDetach()(ok bool)//col:531
AttachingSwitchProcess()(ok bool)//col:575
AttachingQueryCountOfActiveDebuggingThreadsAndProcesses()(ok bool)//col:583
...
func (a *attaching)AttachingCreateProcessDebuggingDetails()(ok bool){//col:63
...
func (a *attaching)AttachingFindProcessDebuggingDetailsByToken()(ok bool){//col:74
...
func (a *attaching)AttachingFindProcessDebuggingDetailsByProcessId()(ok bool){//col:85
...
func (a *attaching)AttachingFindProcessDebuggingDetailsInStartingPhase()(ok bool){//col:96
...
func (a *attaching)AttachingRemoveAndFreeAllProcessDebuggingDetails()(ok bool){//col:105
...
func (a *attaching)AttachingRemoveProcessDebuggingDetailsByToken()(ok bool){//col:118
...
func (a *attaching)AttachingSetStartingPhaseOfProcessDebuggingDetailsByToken()(ok bool){//col:134
...
func (a *attaching)AttachingReachedToProcessEntrypoint()(ok bool){//col:152
...
func (a *attaching)AttachingHandleEntrypointDebugBreak()(ok bool){//col:200
...
func (a *attaching)AttachingAdjustNopSledBuffer()(ok bool){//col:224
...
func (a *attaching)AttachingCheckPageFaultsWithUserDebugger()(ok bool){//col:252
...
func (a *attaching)AttachingConfigureInterceptingThreads()(ok bool){//col:297
...
func (a *attaching)AttachingPerformAttachToProcess()(ok bool){//col:405
...
func (a *attaching)AttachingHandleCr3VmexitsForThreadInterception()(ok bool){//col:433
...
func (a *attaching)AttachingRemoveHooks()(ok bool){//col:463
...
func (a *attaching)AttachingPauseProcess()(ok bool){//col:476
...
func (a *attaching)AttachingKillProcess()(ok bool){//col:508
...
func (a *attaching)AttachingPerformDetach()(ok bool){//col:531
...
func (a *attaching)AttachingSwitchProcess()(ok bool){//col:575
...
func (a *attaching)AttachingQueryCountOfActiveDebuggingThreadsAndProcesses()(ok bool){//col:583
...
func (a *attaching)AttachingQueryDetailsOfActiveDebuggingThreadsAndProcesses()(ok bool){//col:594
...
func (a *attaching)AttachingTargetProcess()(ok bool){//col:625
