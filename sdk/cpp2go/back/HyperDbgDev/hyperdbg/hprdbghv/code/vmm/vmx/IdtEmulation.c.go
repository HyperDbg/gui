package vmx
//back\HyperDbgDev\hyperdbg\hprdbghv\code\vmm\vmx\IdtEmulation.c.back

type (
IdtEmulation interface{
IdtEmulationReInjectInterruptOrException()(ok bool)//col:10
IdtEmulationHandlePageFaults()(ok bool)//col:35
IdtEmulationHandleExceptionAndNmi()(ok bool)//col:127
IdtEmulationInjectInterruptWhenInterruptWindowIsOpen()(ok bool)//col:143
IdtEmulationCheckProcessOrThreadChange()(ok bool)//col:165
IdtEmulationHandleExternalInterrupt()(ok bool)//col:212
...
func (i *idtEmulation)IdtEmulationHandlePageFaults()(ok bool){//col:35
...
func (i *idtEmulation)IdtEmulationHandleExceptionAndNmi()(ok bool){//col:127
...
func (i *idtEmulation)IdtEmulationInjectInterruptWhenInterruptWindowIsOpen()(ok bool){//col:143
...
func (i *idtEmulation)IdtEmulationCheckProcessOrThreadChange()(ok bool){//col:165
...
func (i *idtEmulation)IdtEmulationHandleExternalInterrupt()(ok bool){//col:212
...
func (i *idtEmulation)IdtEmulationHandleNmiWindowExiting()(ok bool){//col:216
...
func (i *idtEmulation)IdtEmulationHandleInterruptWindowExiting()(ok bool){//col:245
