...
MaxSerialPacketSize  =                                   UsermodeBufferSize + 11 +
MaxSerialPacketSize  =                                   UsermodeBufferSize + 11 +        SERIAL_END_OF_BUFFER_CHARS_COUNT
MaxSerialPacketSize  =                                   UsermodeBufferSize + 11 +        SERIAL_END_OF_BUFFER_CHARS_COUNT
MaxSerialPacketSize  =                                   UsermodeBufferSize + 11 +        SERIAL_END_OF_BUFFER_CHARS_COUNT/**
MaxSerialPacketSize  =                                   UsermodeBufferSize + 11 +        SERIAL_END_OF_BUFFER_CHARS_COUNT/** * @brief Final storage size of message tracing
MaxSerialPacketSize  =                                   UsermodeBufferSize + 11 +        SERIAL_END_OF_BUFFER_CHARS_COUNT/** * @brief Final storage size of message tracing *
MaxSerialPacketSize  =                                   UsermodeBufferSize + 11 +        SERIAL_END_OF_BUFFER_CHARS_COUNT/** * @brief Final storage size of message tracing * */
MaxSerialPacketSize  =                                   UsermodeBufferSize + 11 +        SERIAL_END_OF_BUFFER_CHARS_COUNT/** * @brief Final storage size of message tracing * */ LogBufferSize
LogBufferSize  =     MaximumPacketsCapacity *(PacketChunkSize + sizeof(BUFFER_HEADER))
LogBufferSize  =     MaximumPacketsCapacity *(PacketChunkSize + sizeof(BUFFER_HEADER))
LogBufferSize  =     MaximumPacketsCapacity *(PacketChunkSize + sizeof(BUFFER_HEADER))/**
LogBufferSize  =     MaximumPacketsCapacity *(PacketChunkSize + sizeof(BUFFER_HEADER))/** * @brief Final storage size of message tracing
LogBufferSize  =     MaximumPacketsCapacity *(PacketChunkSize + sizeof(BUFFER_HEADER))/** * @brief Final storage size of message tracing *
LogBufferSize  =     MaximumPacketsCapacity *(PacketChunkSize + sizeof(BUFFER_HEADER))/** * @brief Final storage size of message tracing * */
LogBufferSize  =     MaximumPacketsCapacity *(PacketChunkSize + sizeof(BUFFER_HEADER))/** * @brief Final storage size of message tracing * */ LogBufferSizePriority
LogBufferSizePriority  =     MaximumPacketsCapacityPriority *(PacketChunkSize + sizeof(BUFFER_HEADER))
LogBufferSizePriority  =     MaximumPacketsCapacityPriority *(PacketChunkSize + sizeof(BUFFER_HEADER))
LogBufferSizePriority  =     MaximumPacketsCapacityPriority *(PacketChunkSize + sizeof(BUFFER_HEADER))/**
LogBufferSizePriority  =     MaximumPacketsCapacityPriority *(PacketChunkSize + sizeof(BUFFER_HEADER))/** * @brief limitation of Windows DbgPrint message size
LogBufferSizePriority  =     MaximumPacketsCapacityPriority *(PacketChunkSize + sizeof(BUFFER_HEADER))/** * @brief limitation of Windows DbgPrint message size * @details currently is not functional
LogBufferSizePriority  =     MaximumPacketsCapacityPriority *(PacketChunkSize + sizeof(BUFFER_HEADER))/** * @brief limitation of Windows DbgPrint message size * @details currently is not functional *
LogBufferSizePriority  =     MaximumPacketsCapacityPriority *(PacketChunkSize + sizeof(BUFFER_HEADER))/** * @brief limitation of Windows DbgPrint message size * @details currently is not functional * */
LogBufferSizePriority  =     MaximumPacketsCapacityPriority *(PacketChunkSize + sizeof(BUFFER_HEADER))/** * @brief limitation of Windows DbgPrint message size * @details currently is not functional * */ DbgPrintLimitation 512
...
OPERATION_COMMAND_FROM_DEBUGGER_CLOSE_AND_UNLOAD_VMM  =     0x6 | OPERATION_MANDATORY_DEBUGGEE_BIT OPERATION_DEBUGGEE_USER_INPUT     0x7 | OPERATION_MANDATORY_DEBUGGEE_BIT
...
OPERATION_DEBUGGEE_ADD_ACTION_TO_EVENT  =     0x9 | OPERATION_MANDATORY_DEBUGGEE_BIT OPERATION_DEBUGGEE_CLEAR_EVENTS 0xa | OPERATION_MANDATORY_DEBUGGEE_BIT
...
OPERATION_HYPERVISOR_DRIVER_IS_SUCCESSFULLY_LOADED  =     0xb | OPERATION_MANDATORY_DEBUGGEE_BIT OPERATION_HYPERVISOR_DRIVER_END_OF_IRPS
OPERATION_HYPERVISOR_DRIVER_END_OF_IRPS  =     0xc | OPERATION_MANDATORY_DEBUGGEE_BIT
OPERATION_HYPERVISOR_DRIVER_END_OF_IRPS  =     0xc | OPERATION_MANDATORY_DEBUGGEE_BIT OPERATION_COMMAND_FROM_DEBUGGER_RELOAD_SYMBOL
OPERATION_COMMAND_FROM_DEBUGGER_RELOAD_SYMBOL  =     0xd | OPERATION_MANDATORY_DEBUGGEE_BIT
OPERATION_COMMAND_FROM_DEBUGGER_RELOAD_SYMBOL  =     0xd | OPERATION_MANDATORY_DEBUGGEE_BIT
OPERATION_COMMAND_FROM_DEBUGGER_RELOAD_SYMBOL  =     0xd | OPERATION_MANDATORY_DEBUGGEE_BIT OPERATION_NOTIFICATION_FROM_USER_DEBUGGER_PAUSE
OPERATION_NOTIFICATION_FROM_USER_DEBUGGER_PAUSE  =     0xe | OPERATION_MANDATORY_DEBUGGEE_BIT
OPERATION_NOTIFICATION_FROM_USER_DEBUGGER_PAUSE  =     0xe | OPERATION_MANDATORY_DEBUGGEE_BIT
OPERATION_NOTIFICATION_FROM_USER_DEBUGGER_PAUSE  =     0xe | OPERATION_MANDATORY_DEBUGGEE_BIT//////////////////////////////////////////////////
OPERATION_NOTIFICATION_FROM_USER_DEBUGGER_PAUSE  =     0xe | OPERATION_MANDATORY_DEBUGGEE_BIT////////////////////////////////////////////////////            Breakpoint Backup                 //
OPERATION_NOTIFICATION_FROM_USER_DEBUGGER_PAUSE  =     0xe | OPERATION_MANDATORY_DEBUGGEE_BIT////////////////////////////////////////////////////            Breakpoint Backup                 ////////////////////////////////////////////////////
OPERATION_NOTIFICATION_FROM_USER_DEBUGGER_PAUSE  =     0xe | OPERATION_MANDATORY_DEBUGGEE_BIT////////////////////////////////////////////////////            Breakpoint Backup                 ////////////////////////////////////////////////////
OPERATION_NOTIFICATION_FROM_USER_DEBUGGER_PAUSE  =     0xe | OPERATION_MANDATORY_DEBUGGEE_BIT////////////////////////////////////////////////////            Breakpoint Backup                 /////////////////////////////////////////////////////**
OPERATION_NOTIFICATION_FROM_USER_DEBUGGER_PAUSE  =     0xe | OPERATION_MANDATORY_DEBUGGEE_BIT////////////////////////////////////////////////////            Breakpoint Backup                 /////////////////////////////////////////////////////** * @brief maximum number of buffers to be allocated for a single
OPERATION_NOTIFICATION_FROM_USER_DEBUGGER_PAUSE  =     0xe | OPERATION_MANDATORY_DEBUGGEE_BIT////////////////////////////////////////////////////            Breakpoint Backup                 /////////////////////////////////////////////////////** * @brief maximum number of buffers to be allocated for a single * breakpoint
OPERATION_NOTIFICATION_FROM_USER_DEBUGGER_PAUSE  =     0xe | OPERATION_MANDATORY_DEBUGGEE_BIT////////////////////////////////////////////////////            Breakpoint Backup                 /////////////////////////////////////////////////////** * @brief maximum number of buffers to be allocated for a single * breakpoint */
OPERATION_NOTIFICATION_FROM_USER_DEBUGGER_PAUSE  =     0xe | OPERATION_MANDATORY_DEBUGGEE_BIT////////////////////////////////////////////////////            Breakpoint Backup                 /////////////////////////////////////////////////////** * @brief maximum number of buffers to be allocated for a single * breakpoint */ MAXIMUM_BREAKPOINTS_WITHOUT_CONTINUE 50
...
INDICATOR_OF_HYPERDBG_PACKET  =     0x4859504552444247 // HYPERDBG = 0x4859504552444247
INDICATOR_OF_HYPERDBG_PACKET  =     0x4859504552444247 // HYPERDBG = 0x4859504552444247//////////////////////////////////////////////////
INDICATOR_OF_HYPERDBG_PACKET  =     0x4859504552444247 // HYPERDBG = 0x4859504552444247////////////////////////////////////////////////////               Command Details                //
INDICATOR_OF_HYPERDBG_PACKET  =     0x4859504552444247 // HYPERDBG = 0x4859504552444247////////////////////////////////////////////////////               Command Details                ////////////////////////////////////////////////////
INDICATOR_OF_HYPERDBG_PACKET  =     0x4859504552444247 // HYPERDBG = 0x4859504552444247////////////////////////////////////////////////////               Command Details                ////////////////////////////////////////////////////
INDICATOR_OF_HYPERDBG_PACKET  =     0x4859504552444247 // HYPERDBG = 0x4859504552444247////////////////////////////////////////////////////               Command Details                /////////////////////////////////////////////////////**
INDICATOR_OF_HYPERDBG_PACKET  =     0x4859504552444247 // HYPERDBG = 0x4859504552444247////////////////////////////////////////////////////               Command Details                /////////////////////////////////////////////////////** * @brief maximum results that will be returned by !s* s*
INDICATOR_OF_HYPERDBG_PACKET  =     0x4859504552444247 // HYPERDBG = 0x4859504552444247////////////////////////////////////////////////////               Command Details                /////////////////////////////////////////////////////** * @brief maximum results that will be returned by !s* s* * command
INDICATOR_OF_HYPERDBG_PACKET  =     0x4859504552444247 // HYPERDBG = 0x4859504552444247////////////////////////////////////////////////////               Command Details                /////////////////////////////////////////////////////** * @brief maximum results that will be returned by !s* s* * command *
INDICATOR_OF_HYPERDBG_PACKET  =     0x4859504552444247 // HYPERDBG = 0x4859504552444247////////////////////////////////////////////////////               Command Details                /////////////////////////////////////////////////////** * @brief maximum results that will be returned by !s* s* * command * */
INDICATOR_OF_HYPERDBG_PACKET  =     0x4859504552444247 // HYPERDBG = 0x4859504552444247////////////////////////////////////////////////////               Command Details                /////////////////////////////////////////////////////** * @brief maximum results that will be returned by !s* s* * command * */ MaximumSearchResults 0x1000
