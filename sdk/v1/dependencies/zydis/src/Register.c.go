...
type ZydisRegisterMapItem_ struct {
	class   ZydisRegisterClass //col:10
	lo      ZydisRegister      //col:11
	hi      ZydisRegister      //col:12
	width   ZydisRegisterWidth //col:13
	width64 ZydisRegisterWidth //col:14
}
