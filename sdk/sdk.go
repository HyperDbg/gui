...
const GengoLibraryName = "libhybriddbg"
...
var __imp_hyperdbg_u_detect_vmx_support gengort.PreloadProc
...
func init() {
	...
	gengort.Validate((*Anon192_5)(nil), 0x8, 0x8)
	// gengort.Validate((*Anon196_9)(nil), 0x8, 0x8, "Pcid", 0x0, "PageFrameNumber", 0x1, "Reserved1", 0x6, "Reserved_2", 0x7, "PcidInvalidate", 0x7)
	...
	gengort.Validate((*Anon1495_9)(nil), 0x4, 0x4)
	// gengort.Validate((*Anon1497_5)(nil), 0x4, 0x4, "Type", 0x0, "DescriptorType", 0x0, "DescriptorPrivilegeLevel", 0x0, "Present", 0x0, "Reserved1", 0x1, "AvailableBit", 0x1, "LongMode", 0x1, "DefaultBig", 0x1, "Granularity", 0x1, "Unusable", 0x2, "Reserved2", 0x2)
	...
	gengort.Validate((*DebuggerReadMemory)(nil), 0x30, 0x8, "Pid", 0x0, "Address", 0x8, "Size", 0x10, "GetAddressMode", 0x14, "AddressMode", 0x18, "MemoryType", 0x1c, "ReadingType", 0x20, "ReturnLength", 0x24, "KernelStatus", 0x28)
	...
	gengort.Validate((*DebuggerEditMemory)(nil), 0x28, 0x8, "Result", 0x0, "Address", 0x8, "ProcessId", 0x10, "MemoryType", 0x14, "ByteSize", 0x18, "CountOf64Chunks", 0x1c, "FinalStructureSize", 0x20)
	...
	gengort.Validate((*DebuggerPrepareDebuggee)(nil), 0x118, 0x8, "PortAddress", 0x0, "Baudrate", 0x4, "KernelBaseAddress", 0x8, "Result", 0x10, "OsName", 0x14)
	...
	gengort.Validate((*DebuggeeRegisterWriteDescription)(nil), 0x18, 0x8, "RegisterId", 0x0, "Value", 0x8, "KernelStatus", 0x10)
	gengort.Validate((*Symbol)(nil), 0x20, 0x8, "Type", 0x0, "Len", 0x8, "VariableType", 0x10, "Value", 0x18)
	gengort.Validate((*HwdbgShortSymbol)(nil), 0x10, 0x8, "Type", 0x0, "Value", 0x8)
	gengort.Validate((*SymbolBuffer)(nil), 0x18, 0x8, "Head", 0x0, "Pointer", 0x8, "Size", 0xc, "Message", 0x10)
	gengort.Validate((*SymbolMap)(nil), 0x10, 0x8, "Name", 0x0, "Type", 0x8)
	gengort.Validate((*ActionBuffer)(nil), 0x28, 0x8, "Tag", 0x0, "CurrentAction", 0x8, "ImmediatelySendTheResults", 0x10, "Context", 0x18, "CallingStage", 0x20)
...
func DetectVmxSupport() Boolean {
	__res := gengort.CCall0(__imp_hyperdbg_u_detect_vmx_support.Addr())
	return gengort.UnmarshallSyscall[Boolean](__res)
}

var __imp_hyperdbg_u_read_vendor_string gengort.PreloadProc

func ReadVendorString(c *Char) {
	gengort.CCall1(__imp_hyperdbg_u_read_vendor_string.Addr(), gengort.MarshallSyscall(c))
}

var __imp_hyperdbg_u_load_vmm gengort.PreloadProc

func LoadVmm() Int {
	__res := gengort.CCall0(__imp_hyperdbg_u_load_vmm.Addr())
	return gengort.UnmarshallSyscall[Int](__res)
}

var __imp_hyperdbg_u_unload_vmm gengort.PreloadProc

func UnloadVmm() Int {
	__res := gengort.CCall0(__imp_hyperdbg_u_unload_vmm.Addr())
	return gengort.UnmarshallSyscall[Int](__res)
}

var __imp_hyperdbg_u_install_vmm_driver gengort.PreloadProc

func InstallVmmDriver() Int {
	__res := gengort.CCall0(__imp_hyperdbg_u_install_vmm_driver.Addr())
	return gengort.UnmarshallSyscall[Int](__res)
}

var __imp_hyperdbg_u_uninstall_vmm_driver gengort.PreloadProc

func UninstallVmmDriver() Int {
	__res := gengort.CCall0(__imp_hyperdbg_u_uninstall_vmm_driver.Addr())
	return gengort.UnmarshallSyscall[Int](__res)
}

var __imp_hyperdbg_u_stop_vmm_driver gengort.PreloadProc

func StopVmmDriver() Int {
	__res := gengort.CCall0(__imp_hyperdbg_u_stop_vmm_driver.Addr())
	return gengort.UnmarshallSyscall[Int](__res)
}

var __imp_hyperdbg_u_interpreter gengort.PreloadProc

func Interpreter(command *Char) Int {
	__res := gengort.CCall1(__imp_hyperdbg_u_interpreter.Addr(), gengort.MarshallSyscall(command))
	return gengort.UnmarshallSyscall[Int](__res)
}

var __imp_hyperdbg_u_show_signature gengort.PreloadProc

func ShowSignature() { gengort.CCall0(__imp_hyperdbg_u_show_signature.Addr()) }

var __imp_hyperdbg_u_set_text_message_callback gengort.PreloadProc

func SetTextMessageCallback(handler Callback) {
	gengort.CCall1(__imp_hyperdbg_u_set_text_message_callback.Addr(), gengort.MarshallSyscall(handler))
}

var __imp_hyperdbg_u_script_read_file_and_execute_commandline gengort.PreloadProc

func ScriptReadFileAndExecuteCommandline(argc Int, argv **Char) Int {
	__res := gengort.CCall2(__imp_hyperdbg_u_script_read_file_and_execute_commandline.Addr(), gengort.MarshallSyscall(argc), gengort.MarshallSyscall(argv))
	return gengort.UnmarshallSyscall[Int](__res)
}

var __imp_hyperdbg_u_continue_previous_command gengort.PreloadProc

func ContinuePreviousCommand() Boolean {
	__res := gengort.CCall0(__imp_hyperdbg_u_continue_previous_command.Addr())
	return gengort.UnmarshallSyscall[Boolean](__res)
}

var __imp_hyperdbg_u_check_multiline_command gengort.PreloadProc

func CheckMultilineCommand(current_command *Char, reset Boolean) Boolean {
	__res := gengort.CCall2(__imp_hyperdbg_u_check_multiline_command.Addr(), gengort.MarshallSyscall(current_command), gengort.MarshallSyscall(reset))
	return gengort.UnmarshallSyscall[Boolean](__res)
}

var __imp_hyperdbg_u_set_custom_driver_path gengort.PreloadProc

func SetCustomDriverPath(driver_file_path *Char, driver_name *Char) Boolean {
	__res := gengort.CCall2(__imp_hyperdbg_u_set_custom_driver_path.Addr(), gengort.MarshallSyscall(driver_file_path), gengort.MarshallSyscall(driver_name))
	return gengort.UnmarshallSyscall[Boolean](__res)
}

var __imp_hyperdbg_u_use_default_driver_path gengort.PreloadProc

func UseDefaultDriverPath() { gengort.CCall0(__imp_hyperdbg_u_use_default_driver_path.Addr()) }

var __imp_hyperdbg_u_connect_local_debugger gengort.PreloadProc

func ConnectLocalDebugger() { gengort.CCall0(__imp_hyperdbg_u_connect_local_debugger.Addr()) }

var __imp_hyperdbg_u_connect_remote_debugger gengort.PreloadProc

func ConnectRemoteDebugger(ip *Char, port *Char) Boolean {
	__res := gengort.CCall2(__imp_hyperdbg_u_connect_remote_debugger.Addr(), gengort.MarshallSyscall(ip), gengort.MarshallSyscall(port))
	return gengort.UnmarshallSyscall[Boolean](__res)
}

var __imp_hyperdbg_u_connect_remote_debugger_using_com_port gengort.PreloadProc

func ConnectRemoteDebuggerUsingComPort(port_name *Char, baudrate Dword) Boolean {
	__res := gengort.CCall2(__imp_hyperdbg_u_connect_remote_debugger_using_com_port.Addr(), gengort.MarshallSyscall(port_name), gengort.MarshallSyscall(baudrate))
	return gengort.UnmarshallSyscall[Boolean](__res)
}

var __imp_hyperdbg_u_connect_remote_debugger_using_named_pipe gengort.PreloadProc

func ConnectRemoteDebuggerUsingNamedPipe(named_pipe *Char) Boolean {
	__res := gengort.CCall1(__imp_hyperdbg_u_connect_remote_debugger_using_named_pipe.Addr(), gengort.MarshallSyscall(named_pipe))
	return gengort.UnmarshallSyscall[Boolean](__res)
}

var __imp_hyperdbg_u_connect_current_debugger_using_com_port gengort.PreloadProc

func ConnectCurrentDebuggerUsingComPort(port_name *Char, baudrate Dword) Boolean {
	__res := gengort.CCall2(__imp_hyperdbg_u_connect_current_debugger_using_com_port.Addr(), gengort.MarshallSyscall(port_name), gengort.MarshallSyscall(baudrate))
	return gengort.UnmarshallSyscall[Boolean](__res)
}

var __imp_hyperdbg_u_get_kernel_base gengort.PreloadProc

func GetKernelBase() Uint64 {
	__res := gengort.CCall0(__imp_hyperdbg_u_get_kernel_base.Addr())
	return gengort.UnmarshallSyscall[Uint64](__res)
}

var __imp_hyperdbg_u_read_memory gengort.PreloadProc
...
func ReadMemory(target_address Uint64, memory_type DebuggerReadMemoryType, reading_Type DebuggerReadReadingType, pid Uint32, size Uint32, get_address_mode Boolean, address_mode *DebuggerReadMemoryAddressMode, target_buffer_to_store *Byte, return_length *Uint32) Boolean {
	__res := gengort.CCall9(__imp_hyperdbg_u_read_memory.Addr(), gengort.MarshallSyscall(target_address), gengort.MarshallSyscall(memory_type), gengort.MarshallSyscall(reading_Type), gengort.MarshallSyscall(pid), gengort.MarshallSyscall(size), gengort.MarshallSyscall(get_address_mode), gengort.MarshallSyscall(address_mode), gengort.MarshallSyscall(target_buffer_to_store), gengort.MarshallSyscall(return_length))
	return gengort.UnmarshallSyscall[Boolean](__res)
}

var __imp_hyperdbg_u_show_memory_or_disassemble gengort.PreloadProc
...
func ShowMemoryOrDisassemble(style DebuggerShowMemoryStyle, address Uint64, memory_type DebuggerReadMemoryType, reading_type DebuggerReadReadingType, pid Uint32, size Uint32, dt_details PdebuggerDtCommandOptions) {
	gengort.CCall7(__imp_hyperdbg_u_show_memory_or_disassemble.Addr(), gengort.MarshallSyscall(style), gengort.MarshallSyscall(address), gengort.MarshallSyscall(memory_type), gengort.MarshallSyscall(reading_type), gengort.MarshallSyscall(pid), gengort.MarshallSyscall(size), gengort.MarshallSyscall(dt_details))
}

var __imp_hyperdbg_u_write_memory gengort.PreloadProc
...
func WriteMemory(destination_address unsafe.Pointer, memory_type DebuggerEditMemoryType, process_id Uint32, source_address unsafe.Pointer, number_of_bytes Uint32) Boolean {
	__res := gengort.CCall5(__imp_hyperdbg_u_write_memory.Addr(), gengort.MarshallSyscall(destination_address), gengort.MarshallSyscall(memory_type), gengort.MarshallSyscall(process_id), gengort.MarshallSyscall(source_address), gengort.MarshallSyscall(number_of_bytes))
	return gengort.UnmarshallSyscall[Boolean](__res)
}

var __imp_hyperdbg_u_read_all_registers gengort.PreloadProc

func ReadAllRegisters(guest_registers *GuestRegs, extra_registers *GuestExtraRegisters) Boolean {
	__res := gengort.CCall2(__imp_hyperdbg_u_read_all_registers.Addr(), gengort.MarshallSyscall(guest_registers), gengort.MarshallSyscall(extra_registers))
	return gengort.UnmarshallSyscall[Boolean](__res)
}

var __imp_hyperdbg_u_read_target_register gengort.PreloadProc

func ReadTargetRegister(register_id RegsEnum, target_register *Uint64) Boolean {
	__res := gengort.CCall2(__imp_hyperdbg_u_read_target_register.Addr(), gengort.MarshallSyscall(register_id), gengort.MarshallSyscall(target_register))
	return gengort.UnmarshallSyscall[Boolean](__res)
}

var __imp_hyperdbg_u_write_target_register gengort.PreloadProc

func WriteTargetRegister(register_id RegsEnum, value Uint64) Boolean {
	__res := gengort.CCall2(__imp_hyperdbg_u_write_target_register.Addr(), gengort.MarshallSyscall(register_id), gengort.MarshallSyscall(value))
	return gengort.UnmarshallSyscall[Boolean](__res)
}

var __imp_hyperdbg_u_show_all_registers gengort.PreloadProc

func ShowAllRegisters() Boolean {
	__res := gengort.CCall0(__imp_hyperdbg_u_show_all_registers.Addr())
	return gengort.UnmarshallSyscall[Boolean](__res)
}

var __imp_hyperdbg_u_show_target_register gengort.PreloadProc

func ShowTargetRegister(register_id RegsEnum) Boolean {
	__res := gengort.CCall1(__imp_hyperdbg_u_show_target_register.Addr(), gengort.MarshallSyscall(register_id))
	return gengort.UnmarshallSyscall[Boolean](__res)
}

var __imp_hyperdbg_u_continue_debuggee gengort.PreloadProc

func ContinueDebuggee() { gengort.CCall0(__imp_hyperdbg_u_continue_debuggee.Addr()) }

var __imp_hyperdbg_u_pause_debuggee gengort.PreloadProc

func PauseDebuggee() { gengort.CCall0(__imp_hyperdbg_u_pause_debuggee.Addr()) }

var __imp_hyperdbg_u_set_breakpoint gengort.PreloadProc

func SetBreakpoint(address Uint64, pid Uint32, tid Uint32, core_numer Uint32) {
	gengort.CCall4(__imp_hyperdbg_u_set_breakpoint.Addr(), gengort.MarshallSyscall(address), gengort.MarshallSyscall(pid), gengort.MarshallSyscall(tid), gengort.MarshallSyscall(core_numer))
}

var __imp_hyperdbg_u_start_process gengort.PreloadProc

func StartProcess(path *Wchar) Boolean {
	__res := gengort.CCall1(__imp_hyperdbg_u_start_process.Addr(), gengort.MarshallSyscall(path))
	return gengort.UnmarshallSyscall[Boolean](__res)
}

var __imp_hyperdbg_u_start_process_with_args gengort.PreloadProc

func StartProcessWithArgs(path *Wchar, arguments *Wchar) Boolean {
	__res := gengort.CCall2(__imp_hyperdbg_u_start_process_with_args.Addr(), gengort.MarshallSyscall(path), gengort.MarshallSyscall(arguments))
	return gengort.UnmarshallSyscall[Boolean](__res)
}
...
func (s Anon192_5) Fields() Anon196_9 {
	return gengort.ReadBitcast[Anon196_9](unsafe.Add(unsafe.Pointer(unsafe.SliceData(s.Raw[:])), 0))
}
...
func (s Anon1495_9) Get() Anon1497_5 {
	return gengort.ReadBitcast[Anon1497_5](unsafe.Add(unsafe.Pointer(unsafe.SliceData(s.Raw[:])), 0))
}

func (s *Anon1495_9) Set(v Anon1497_5) {
	gengort.WriteBitcast(unsafe.Add(unsafe.Pointer(unsafe.SliceData(s.Raw[:])), 0), v)
}
