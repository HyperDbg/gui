...
//binding\codespace\gui\sdk\HyperDbgDev\hyperdbg\hprdbgctrl\code\debugger\commands\debugging-commands\test.cpp.back

type (
Test interface{
CommandTestHelp()(ok bool)//col:9
CommandTestPerformKernelTestsIoctl()(ok bool)//col:40
CommandTestPerformTest()(ok bool)//col:97
CommandTestInVmiMode()(ok bool)//col:131
...
func (t *test)CommandTestPerformKernelTestsIoctl()(ok bool){//col:40
...
func (t *test)CommandTestPerformTest()(ok bool){//col:97
...
func (t *test)CommandTestInVmiMode()(ok bool){//col:131
/*CommandTestInVmiMode()
{
    ...
    Status = DeviceIoControl(
        g_DeviceHandle,                                   
        IOCTL_SEND_GET_KERNEL_SIDE_TEST_INFORMATION,      
        KernelSideTestInformationRequestArray,            
...
func (t *test)CommandTestQueryState()(ok bool){//col:141
...
func (t *test)CommandTest()(ok bool){//col:158
