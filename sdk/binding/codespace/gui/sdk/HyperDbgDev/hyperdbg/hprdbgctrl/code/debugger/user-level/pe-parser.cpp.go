package user-level
//binding\codespace\gui\sdk\HyperDbgDev\hyperdbg\hprdbgctrl\code\debugger\user-level\pe-parser.cpp.back

type (
PeParser interface{
PeHexDump()(ok bool)//col:31
...
func (p *peParser)PeShowSectionInformationAndDump()(ok bool){//col:328
...
func (p *peParser)PeIsPE32BitOr64Bit()(ok bool){//col:398
