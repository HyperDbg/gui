...
//binding\codespace\gui\sdk\HyperDbgDev\hyperdbg\hprdbgctrl\code\debugger\commands\debugging-commands\cpu.cpp.back

type (
Cpu interface{
CommandCpuHelp()(ok bool)//col:5
CommandCpu()(ok bool)//col:15
____static_std::string_Vendor()(ok bool)//col:153
...
func (c *cpu)CommandCpu()(ok bool){//col:15
...
func (c *cpu)____static_std::string_Vendor()(ok bool){//col:153
...
func (c *cpu)ReadVendorString()(ok bool){//col:159
/*ReadVendorString()
{
...
func (c *cpu)ReadCpuDetails()(ok bool){//col:221
/*ReadCpuDetails()
{
