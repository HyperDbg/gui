...
//binding\codespace\gui\sdk\HyperDbgDev\hyperdbg\hprdbgctrl\code\debugger\commands\debugging-commands\bd.cpp.back

type (
	Bd interface {
		CommandBdHelp() (ok bool) //col:8
		CommandBd() (ok bool)     //col:36
	}
	bd struct{}
)
...
func (b *bd) CommandBdHelp() (ok bool) { //col:8
	/*
	   CommandBdHelp()
...
func (b *bd) CommandBd() (ok bool) { //col:36
	/*
