...
//binding\codespace\gui\sdk\HyperDbgDev\hyperdbg\hprdbgctrl\code\debugger\commands\extension-commands\va2pa.cpp.back

type (
Va2pa interface{
CommandVa2paHelp()(ok bool)//col:12
CommandVa2pa()(ok bool)//col:122
}
)

func NewVa2pa() { return & va2pa{} }

func (v *va2pa)CommandVa2paHelp()(ok bool){//col:12
/*CommandVa2paHelp()
{
...
func (v *va2pa)CommandVa2pa()(ok bool){//col:122
