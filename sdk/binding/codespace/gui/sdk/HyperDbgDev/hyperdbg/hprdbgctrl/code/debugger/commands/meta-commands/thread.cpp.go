...
//binding\codespace\gui\sdk\HyperDbgDev\hyperdbg\hprdbgctrl\code\debugger\commands\meta-commands\thread.cpp.back

type (
	Thread interface {
		CommandThreadHelp() (ok bool)        //col:21
...
func (t *thread) CommandThreadListThreads() (ok bool) { //col:63
...
func (t *thread) CommandThread() (ok bool) { //col:218
