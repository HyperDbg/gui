...
//binding\codespace\gui\sdk\HyperDbgDev\hyperdbg\hprdbgctrl\code\debugger\commands\extension-commands\epthook.cpp.back

type (
	Epthook interface {
		CommandEptHookHelp() (ok bool) //col:15
		CommandEptHook() (ok bool)     //col:108
	}
	epthook struct{}
)
...
func (e *epthook) CommandEptHookHelp() (ok bool) { //col:15
	/*CommandEptHookHelp()
	  {
...
func (e *epthook) CommandEptHook() (ok bool) { //col:108
