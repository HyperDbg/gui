...
//binding\codespace\gui\sdk\HyperDbgDev\hyperdbg\hprdbgctrl\code\debugger\transparency\gaussian-rng.cpp.back

type (
	GaussianRng interface {
		Median() (ok bool)                      //col:20
		Average() (ok bool)                     //col:30
		CalculateStandardDeviation() (ok bool)  //col:39
		MedianAbsoluteDeviationTest() (ok bool) //col:51
		Randn() (ok bool)                       //col:73
...
func (g *gaussianRng) CalculateStandardDeviation() (ok bool) { //col:39
	/*
...
func (g *gaussianRng) MedianAbsoluteDeviationTest() (ok bool) { //col:51
	/*
...
func (g *gaussianRng) Randn() (ok bool) { //col:73
	/*
...
func (g *gaussianRng) GuassianGenerateRandom() (ok bool) { //col:104
	/*
...
func (g *gaussianRng) TestGaussianFromFile() (ok bool) { //col:122
	/*
