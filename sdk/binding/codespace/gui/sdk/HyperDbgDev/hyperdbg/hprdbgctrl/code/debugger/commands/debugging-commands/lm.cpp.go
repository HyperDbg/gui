...
//binding\codespace\gui\sdk\HyperDbgDev\hyperdbg\hprdbgctrl\code\debugger\commands\debugging-commands\lm.cpp.back

type (
	Lm interface {
		CommandLmHelp() (ok bool)                 //col:13
		CommandLmShowUserModeModule() (ok bool)   //col:124
...
func (l *lm) CommandLmShowUserModeModule() (ok bool) { //col:124
	/*
...
func (l *lm) CommandLmShowKernelModeModule() (ok bool) { //col:194
	/*
...
func (l *lm) CommandLm() (ok bool) { //col:309
	/*
