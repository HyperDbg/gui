...
//binding\codespace\gui\sdk\HyperDbgDev\hyperdbg\hprdbgctrl\code\debugger\commands\debugging-commands\dt-struct.cpp.back

type (
DtStruct interface{
CommandDtHelp()(ok bool)//col:27
CommandStructHelp()(ok bool)//col:41
CommandDtAndStructConvertHyperDbgArgsToPdbex()(ok bool)//col:194
...
func (d *dtStruct)CommandStructHelp()(ok bool){//col:41
/*CommandStructHelp()
{
...
func (d *dtStruct)CommandDtAndStructConvertHyperDbgArgsToPdbex()(ok bool){//col:194
...
func (d *dtStruct)CommandDtShowDataBasedOnSymbolTypes()(ok bool){//col:250
...
func (d *dtStruct)CommandDtAndStruct()(ok bool){//col:412
