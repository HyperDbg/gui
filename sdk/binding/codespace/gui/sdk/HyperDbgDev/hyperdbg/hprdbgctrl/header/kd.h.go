...
const (
	DbgWaitForKernelResponse (KernelSyncObjectId) = do{DEBUGGER_SYNCRONIZATION_EVENTS_STATE * SyncronizationObject = &g_KernelSyncronizationObjectsHandleTable[KernelSyncObjectId]; SyncronizationObject->IsOnWaitingState = TRUE; WaitForSingleObject(SyncronizationObject->EventHandle, INFINITE)} while (
FALSE
)                                                                                                                                                                                                                                                                                               //col:1
