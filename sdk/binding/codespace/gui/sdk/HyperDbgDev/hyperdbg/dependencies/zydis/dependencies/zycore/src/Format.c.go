...
//binding\codespace\gui\sdk\HyperDbgDev\hyperdbg\dependencies\zydis\dependencies\zycore\src\Format.c.back
...
type (
	Format interface {
		static_const_ZyanStringView_STR_ADD_ = _ZYAN_DEFINE_STRING_VIEW()
(ok bool) //col:41
