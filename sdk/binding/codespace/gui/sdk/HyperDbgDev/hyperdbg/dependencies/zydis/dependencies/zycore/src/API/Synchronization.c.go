...
type (
	Synchronization interface {
		...
		ZyanStatus_ZyanCriticalSectionInitialize() (ok bool) //col:93
		ZyanStatus_ZyanCriticalSectionEnter() (ok bool)      //col:98
		ZyanBool_ZyanCriticalSectionTryEnter() (ok bool)     //col:102
...
func (s *synchronization) ZyanStatus_ZyanCriticalSectionInitialize() (ok bool) { //col:93
	/*
	   ZyanStatus ZyanCriticalSectionInitialize(ZyanCriticalSection* critical_section)
...
func (s *synchronization) ZyanStatus_ZyanCriticalSectionEnter() (ok bool) { //col:98
	/*
	   ZyanStatus ZyanCriticalSectionEnter(ZyanCriticalSection* critical_section)
...
func (s *synchronization) ZyanBool_ZyanCriticalSectionTryEnter() (ok bool) { //col:102
	/*
	   ZyanBool ZyanCriticalSectionTryEnter(ZyanCriticalSection* critical_section)
...
func (s *synchronization) ZyanStatus_ZyanCriticalSectionLeave() (ok bool) { //col:107
	/*
	   ZyanStatus ZyanCriticalSectionLeave(ZyanCriticalSection* critical_section)
...
func (s *synchronization) ZyanStatus_ZyanCriticalSectionDelete() (ok bool) { //col:112
	/*
	   ZyanStatus ZyanCriticalSectionDelete(ZyanCriticalSection* critical_section)
