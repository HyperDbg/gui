package src
//binding\codespace\gui\sdk\HyperDbgDev\hyperdbg\dependencies\zydis\src\SharedData.c.back

const(
ZYDIS_OPERAND_DEFINITION(type, encoding, access) = { type, encoding, access } //col:1
)

type (
SharedData interface{
void_ZydisGetInstructionDefinition()(ok bool)//col:31
ZyanU8_ZydisGetOperandDefinitions()(ok bool)//col:43
...
func (s *sharedData)ZyanU8_ZydisGetOperandDefinitions()(ok bool){//col:43
...
func (s *sharedData)void_ZydisGetElementInfo()(ok bool){//col:80
...
func (s *sharedData)ZyanBool_ZydisGetAccessedFlags()(ok bool){//col:87
