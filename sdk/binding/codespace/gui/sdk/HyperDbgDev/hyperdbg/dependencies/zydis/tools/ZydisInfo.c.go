package tools
//binding\codespace\gui\sdk\HyperDbgDev\hyperdbg\dependencies\zydis\tools\ZydisInfo.c.back

const(
COLOR_DEFAULT =       ZYAN_VT100SGR_FG_DEFAULT //col:1
COLOR_ERROR =         ZYAN_VT100SGR_FG_BRIGHT_RED //col:2
COLOR_HEADER =        ZYAN_VT100SGR_FG_DEFAULT //col:3
COLOR_HEADER_TITLE =  ZYAN_VT100SGR_FG_CYAN //col:4
COLOR_VALUE_LABEL =   ZYAN_VT100SGR_FG_DEFAULT //col:5
COLOR_VALUE_R =       ZYAN_VT100SGR_FG_BRIGHT_RED //col:6
COLOR_VALUE_G =       ZYAN_VT100SGR_FG_BRIGHT_GREEN //col:7
COLOR_VALUE_B =       ZYAN_VT100SGR_FG_CYAN //col:8
CVT100_OUT(sequence) = (g_vt100_stdout ? (sequence) : "") //col:9
CVT100_ERR(sequence) = (g_vt100_stderr ? (sequence) : "") //col:10
PRINT_VALUE_R(name, format, ...) = PrintValueLabel(name); ZYAN_PRINTF("%s" format "%sn", CVT100_OUT(COLOR_VALUE_R), __VA_ARGS__, CVT100_OUT(COLOR_DEFAULT)); //col:11
PRINT_VALUE_G(name, format, ...) = PrintValueLabel(name); ZYAN_PRINTF("%s" format "%sn", CVT100_OUT(COLOR_VALUE_G), __VA_ARGS__, CVT100_OUT(COLOR_DEFAULT)); //col:15
PRINT_VALUE_B(name, format, ...) = PrintValueLabel(name); ZYAN_PRINTF("%s" format "%sn", CVT100_OUT(COLOR_VALUE_B), __VA_ARGS__, CVT100_OUT(COLOR_DEFAULT)); //col:19
)

type (
ZydisInfo interface{
static_const_charPtr_FormatZyanStatus()(ok bool)//col:45
static_void_PrintSectionHeader()(ok bool)//col:53
static_void_PrintValueLabel()(ok bool)//col:58
static_void_PrintSegments()(ok bool)//col:183
static_void_PrintOperands()(ok bool)//col:379
static_void_PrintFlags()(ok bool)//col:445
static_void_PrintAVXInfo()(ok bool)//col:530
static_void_PrintTokenizedInstruction()(ok bool)//col:582
static_void_PrintDisassembly()(ok bool)//col:624
...
func (z *zydisInfo)static_void_PrintSectionHeader()(ok bool){//col:53
...
func (z *zydisInfo)static_void_PrintValueLabel()(ok bool){//col:58
...
func (z *zydisInfo)static_void_PrintSegments()(ok bool){//col:183
...
func (z *zydisInfo)static_void_PrintOperands()(ok bool){//col:379
...
func (z *zydisInfo)static_void_PrintFlags()(ok bool){//col:445
...
func (z *zydisInfo)static_void_PrintAVXInfo()(ok bool){//col:530
...
func (z *zydisInfo)static_void_PrintTokenizedInstruction()(ok bool){//col:582
...
func (z *zydisInfo)static_void_PrintDisassembly()(ok bool){//col:624
...
func (z *zydisInfo)static_void_PrintInstruction()(ok bool){//col:806
...
func (z *zydisInfo)int_main()(ok bool){//col:911
