...
const (
	MY_RAND_MAX = 32768 //col:1
)

type (
	Transparency interface {
		TransparentGetRand() (ok bool)                     //col:8
		TransparentPow() (ok bool)                         //col:17
		TransparentLog() (ok bool)                         //col:28
		TransparentSqrt() (ok bool)                        //col:48
		TransparentRandn() (ok bool)                       //col:75
		TransparentAddNameOrProcessIdToTheList() (ok bool) //col:109
		TransparentHideDebugger() (ok bool)                //col:138
...
func (t *transparency) TransparentPow() (ok bool) { //col:17
	/*
...
func (t *transparency) TransparentLog() (ok bool) { //col:28
	/*
...
func (t *transparency) TransparentSqrt() (ok bool) { //col:48
	/*
...
func (t *transparency) TransparentRandn() (ok bool) { //col:75
	/*
...
func (t *transparency) TransparentAddNameOrProcessIdToTheList() (ok bool) { //col:109
	/*
...
func (t *transparency) TransparentHideDebugger() (ok bool) { //col:138
	/*
...
func (t *transparency) TransparentUnhideDebugger() (ok bool) { //col:163
	/*
...
func (t *transparency) TransparentModeStart() (ok bool) { //col:249
	/*
