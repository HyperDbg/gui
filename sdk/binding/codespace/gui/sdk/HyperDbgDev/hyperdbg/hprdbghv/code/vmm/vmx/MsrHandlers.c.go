package vmx
//binding\codespace\gui\sdk\HyperDbgDev\hyperdbg\hprdbghv\code\vmm\vmx\MsrHandlers.c.back

type (
MsrHandlers interface{
MsrHandleRdmsrVmexit()(ok bool)//col:52
MsrHandleWrmsrVmexit()(ok bool)//col:107
MsrHandleSetMsrBitmap()(ok bool)//col:142
MsrHandleUnSetMsrBitmap()(ok bool)//col:177
MsrHandleFilterMsrReadBitmap()(ok bool)//col:184
MsrHandleFilterMsrWriteBitmap()(ok bool)//col:193
MsrHandlePerformMsrBitmapReadChange()(ok bool)//col:207
MsrHandlePerformMsrBitmapReadReset()(ok bool)//col:213
...
func (m *msrHandlers)MsrHandleWrmsrVmexit()(ok bool){//col:107
...
func (m *msrHandlers)MsrHandleSetMsrBitmap()(ok bool){//col:142
...
func (m *msrHandlers)MsrHandleUnSetMsrBitmap()(ok bool){//col:177
...
func (m *msrHandlers)MsrHandleFilterMsrReadBitmap()(ok bool){//col:184
...
func (m *msrHandlers)MsrHandleFilterMsrWriteBitmap()(ok bool){//col:193
...
func (m *msrHandlers)MsrHandlePerformMsrBitmapReadChange()(ok bool){//col:207
...
func (m *msrHandlers)MsrHandlePerformMsrBitmapReadReset()(ok bool){//col:213
...
func (m *msrHandlers)MsrHandlePerformMsrBitmapWriteChange()(ok bool){//col:227
...
func (m *msrHandlers)MsrHandlePerformMsrBitmapWriteReset()(ok bool){//col:233
