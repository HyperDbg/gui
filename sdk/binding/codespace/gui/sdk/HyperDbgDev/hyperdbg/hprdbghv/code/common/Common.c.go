package common
//binding\codespace\gui\sdk\HyperDbgDev\hyperdbg\hprdbghv\code\common\Common.c.back

const(
SELECTOR_TABLE_LDT = 0x1 //col:1
SELECTOR_TABLE_GDT = 0x0 //col:2
)

type (
Common interface{
MathPower()(ok bool)//col:19
BroadcastToProcessors()(ok bool)//col:29
TestBit()(ok bool)//col:33
ClearBit()(ok bool)//col:37
SetBit()(ok bool)//col:41
VirtualAddressToPhysicalAddress()(ok bool)//col:45
GetCr3FromProcessId()(ok bool)//col:58
SwitchOnAnotherProcessMemoryLayout()(ok bool)//col:74
SwitchOnMemoryLayoutOfTargetProcess()(ok bool)//col:83
SwitchOnAnotherProcessMemoryLayoutByCr3()(ok bool)//col:90
GetSegmentDescriptor()(ok bool)//col:124
RestoreToPreviousProcess()(ok bool)//col:128
PhysicalAddressToVirtualAddressByProcessId()(ok bool)//col:143
PhysicalAddressToVirtualAddressByCr3()(ok bool)//col:158
PhysicalAddressToVirtualAddressOnTargetProcess()(ok bool)//col:165
GetRunningCr3OnTargetProcess()(ok bool)//col:172
VirtualAddressToPhysicalAddressByProcessId()(ok bool)//col:185
VirtualAddressToPhysicalAddressByProcessCr3()(ok bool)//col:198
VirtualAddressToPhysicalAddressOnTargetProcess()(ok bool)//col:213
PhysicalAddressToVirtualAddress()(ok bool)//col:219
FindSystemDirectoryTableBase()(ok bool)//col:224
GetProcessNameFromEprocess()(ok bool)//col:230
StartsWith()(ok bool)//col:236
IsProcessExist()(ok bool)//col:250
CheckIfAddressIsValidUsingTsx()(ok bool)//col:267
GetCpuid()(ok bool)//col:271
CheckCpuSupportRtm()(ok bool)//col:281
Getx86VirtualAddressWidth()(ok bool)//col:287
CheckCanonicalVirtualAddress()(ok bool)//col:309
CheckMemoryAccessSafety()(ok bool)//col:358
VmxrootCompatibleStrlen()(ok bool)//col:398
VmxrootCompatibleWcslen()(ok bool)//col:439
AllocateInvalidMsrBimap()(ok bool)//col:461
GetHandleFromProcess()(ok bool)//col:473
...
func (c *common)BroadcastToProcessors()(ok bool){//col:29
...
func (c *common)TestBit()(ok bool){//col:33
...
func (c *common)ClearBit()(ok bool){//col:37
...
func (c *common)SetBit()(ok bool){//col:41
...
func (c *common)VirtualAddressToPhysicalAddress()(ok bool){//col:45
...
func (c *common)GetCr3FromProcessId()(ok bool){//col:58
...
func (c *common)SwitchOnAnotherProcessMemoryLayout()(ok bool){//col:74
...
func (c *common)SwitchOnMemoryLayoutOfTargetProcess()(ok bool){//col:83
...
func (c *common)SwitchOnAnotherProcessMemoryLayoutByCr3()(ok bool){//col:90
...
func (c *common)GetSegmentDescriptor()(ok bool){//col:124
...
func (c *common)RestoreToPreviousProcess()(ok bool){//col:128
...
func (c *common)PhysicalAddressToVirtualAddressByProcessId()(ok bool){//col:143
...
func (c *common)PhysicalAddressToVirtualAddressByCr3()(ok bool){//col:158
...
func (c *common)PhysicalAddressToVirtualAddressOnTargetProcess()(ok bool){//col:165
...
func (c *common)GetRunningCr3OnTargetProcess()(ok bool){//col:172
...
func (c *common)VirtualAddressToPhysicalAddressByProcessId()(ok bool){//col:185
...
func (c *common)VirtualAddressToPhysicalAddressByProcessCr3()(ok bool){//col:198
...
func (c *common)VirtualAddressToPhysicalAddressOnTargetProcess()(ok bool){//col:213
...
func (c *common)PhysicalAddressToVirtualAddress()(ok bool){//col:219
...
func (c *common)FindSystemDirectoryTableBase()(ok bool){//col:224
...
func (c *common)GetProcessNameFromEprocess()(ok bool){//col:230
...
func (c *common)StartsWith()(ok bool){//col:236
...
func (c *common)IsProcessExist()(ok bool){//col:250
...
func (c *common)CheckIfAddressIsValidUsingTsx()(ok bool){//col:267
...
func (c *common)GetCpuid()(ok bool){//col:271
...
func (c *common)CheckCpuSupportRtm()(ok bool){//col:281
/*CheckCpuSupportRtm()
{
    int     Regs1[4];
    int     Regs2[4];
...
func (c *common)Getx86VirtualAddressWidth()(ok bool){//col:287
...
func (c *common)CheckCanonicalVirtualAddress()(ok bool){//col:309
...
func (c *common)CheckMemoryAccessSafety()(ok bool){//col:358
...
func (c *common)VmxrootCompatibleStrlen()(ok bool){//col:398
...
func (c *common)VmxrootCompatibleWcslen()(ok bool){//col:439
...
func (c *common)AllocateInvalidMsrBimap()(ok bool){//col:461
...
func (c *common)GetHandleFromProcess()(ok bool){//col:473
...
func (c *common)UndocumentedNtOpenProcess()(ok bool){//col:513
...
func (c *common)KillProcess()(ok bool){//col:562
