...
VmxAllocateVmxonRegion()(ok bool)//col:38
VmxAllocateVmcsRegion()(ok bool)//col:69
VmxAllocateVmmStack()(ok bool)//col:82
...
func (v *vmxRegions)VmxAllocateVmcsRegion()(ok bool){//col:69
...
func (v *vmxRegions)VmxAllocateVmmStack()(ok bool){//col:82
...
func (v *vmxRegions)VmxAllocateMsrBitmap()(ok bool){//col:97
...
func (v *vmxRegions)VmxAllocateIoBitmaps()(ok bool){//col:122
/*VmxAllocateIoBitmaps(_In_ INT ProcessorID)
{
    VIRTUAL_MACHINE_STATE * CurrentVmState = &g_GuestState[ProcessorID];
    CurrentVmState->IoBitmapVirtualAddressA = ExAllocatePoolWithTag(NonPagedPool, PAGE_SIZE, POOLTAG); 
    ...
    CurrentVmState->IoBitmapVirtualAddressB = ExAllocatePoolWithTag(NonPagedPool, PAGE_SIZE, POOLTAG); 
