package syscall_hook

//binding\codespace\gui\sdk\HyperDbgDev\hyperdbg\hprdbghv\code\debugger\features\hooks\syscall-hook\SsdtHook.c.back

type (
	SsdtHook interface {
		SyscallHookGetKernelBase() (ok bool)      //col:46
		SyscallHookFindSsdt() (ok bool)           //col:90
		SyscallHookGetFunctionAddress() (ok bool) //col:120
...
func (s *ssdtHook) SyscallHookFindSsdt() (ok bool) { //col:90
	/*
	   SyscallHookFindSsdt(PUINT64 NtTable, PUINT64 Win32kTable)

	   	{
	   	    ...
	   	    win32kTable = (PVOID)((ULONG_PTR)shadow + 0x20);
	   	    *NtTable     = ntTable;
...
func (s *ssdtHook) SyscallHookGetFunctionAddress() (ok bool) { //col:120
	/*
...
func (s *ssdtHook) NtCreateFileHook() (ok bool) { //col:161
	/*
	   NtCreateFileHook(
...
func (s *ssdtHook) SyscallHookTest() (ok bool) { //col:175
	/*
	   SyscallHookTest()
