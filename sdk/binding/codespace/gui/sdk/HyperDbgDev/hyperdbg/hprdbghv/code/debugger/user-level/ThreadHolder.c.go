...
//binding\codespace\gui\sdk\HyperDbgDev\hyperdbg\hprdbghv\code\debugger\user-level\ThreadHolder.c.back

type (
	ThreadHolder interface {
		ThreadHolderAllocateThreadHoldingBuffers() (ok bool)                     //col:5
		ThreadHolderAssignThreadHolderToProcessDebuggingDetails() (ok bool)      //col:18
		ThreadHolderIsAnyPausedThreadInProcess() (ok bool)                       //col:37
		ThreadHolderGetProcessThreadDetailsByProcessIdAndThreadId() (ok bool)    //col:62
		ThreadHolderGetProcessFirstThreadDetailsByProcessId() (ok bool)          //col:87
		ThreadHolderGetProcessDebuggingDetailsByThreadId() (ok bool)             //col:114
		ThreadHolderFindOrCreateThreadDebuggingDetail() (ok bool)                //col:163
		ThreadHolderApplyActionToPausedThreads() (ok bool)                       //col:218
		ThreadHolderFreeHoldingStructures() (ok bool)                            //col:230
...
func (t *threadHolder) ThreadHolderAssignThreadHolderToProcessDebuggingDetails() (ok bool) { //col:18
	/*
...
func (t *threadHolder) ThreadHolderIsAnyPausedThreadInProcess() (ok bool) { //col:37
	/*
...
func (t *threadHolder) ThreadHolderGetProcessThreadDetailsByProcessIdAndThreadId() (ok bool) { //col:62
	/*
...
func (t *threadHolder) ThreadHolderGetProcessFirstThreadDetailsByProcessId() (ok bool) { //col:87
	/*
...
func (t *threadHolder) ThreadHolderGetProcessDebuggingDetailsByThreadId() (ok bool) { //col:114
	/*
...
func (t *threadHolder) ThreadHolderFindOrCreateThreadDebuggingDetail() (ok bool) { //col:163
	/*
...
func (t *threadHolder) ThreadHolderApplyActionToPausedThreads() (ok bool) { //col:218
	/*
...
func (t *threadHolder) ThreadHolderFreeHoldingStructures() (ok bool) { //col:230
	/*
...
func (t *threadHolder) ThreadHolderQueryCountOfActiveDebuggingThreadsAndProcesses() (ok bool) { //col:259
	/*
...
func (t *threadHolder) ThreadHolderQueryDetailsOfActiveDebuggingThreadsAndProcesses() (ok bool) { //col:306
	/*
