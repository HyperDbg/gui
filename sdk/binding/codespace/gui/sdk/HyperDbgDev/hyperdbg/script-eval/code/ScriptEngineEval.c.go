...
//binding\codespace\gui\sdk\HyperDbgDev\hyperdbg\script-eval\code\ScriptEngineEval.c.back

type (
	ScriptEngineEval interface {
		GetPseudoRegValue() (ok bool)           //col:45
		GetValue() (ok bool)                    //col:85
		SetValue() (ok bool)                    //col:103
...
func (s *scriptEngineEval) GetValue() (ok bool) { //col:85
...
func (s *scriptEngineEval) SetValue() (ok bool) { //col:103
...
func (s *scriptEngineEval) ScriptEngineGetOperatorName() (ok bool) { //col:133
...
func (s *scriptEngineEval) ScriptEngineExecute() (ok bool) { //col:957
