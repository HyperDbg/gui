func Bc:ClearsBreakpointBreakpointId.() {
Interpreter(StringToBytePointer("Bc")) 
}

func Bd:DisablesBreakpointBreakpointId.() {
Interpreter(StringToBytePointer("Bd")) 
}

func Be:EnablesBreakpointBreakpointId.() {
Interpreter(StringToBytePointer("Be")) 
}

func Bl:ListsAllEnabledAndDisabledBreakpoints.() {
Interpreter(StringToBytePointer("Bl")) 
}

func Bp:PutsBreakpoint(0xcc).() {
...
func Cpu:CollectsReportFromCpuFeatures.() {
