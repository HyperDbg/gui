...
target("zydis")
set_kind("static")
add_headerfiles("hyperdbg/dependencies/zydis/dependencies/zycore/include/*.h")
...
add_includedirs("hyperdbg/include/", { public = true })
add_defines("ZYCORE_STATIC_DEFINE", "ZYDIS_STATIC_DEFINE")
...
add_includedirs("hyperdbg/dependencies/", { public = true })
add_includedirs("hyperdbg/include/", { public = true })
add_deps("kdserial", "script-engine")
add_defines("MANIFEST=NO", "MAP", "FAcs")
