...
#        endif
ZYAN_INLINE void *
ZYAN_MEMCHR(const void * str, int c, ZyanUSize n) {
...
ZYAN_INLINE void *
ZYAN_MEMCPY(void * dst, const void * src, ZyanUSize n) {
...
ZYAN_INLINE void *
ZYAN_MEMMOVE(void * dst, const void * src, ZyanUSize n) {
...
ZYAN_INLINE void *
ZYAN_MEMSET(void * dst, int val, ZyanUSize n) {
...
ZYAN_INLINE char *
ZYAN_STRCAT(char * dest, const char * src) {
    char * ret = dest;
    while (*dest) {
        dest++;
    }
...
ZYAN_INLINE char *
ZYAN_STRCHR(const char * s, int c) {
    while (*s != (char)c) {
        if (!*s++) {
            return 0;
        }
...
ZYAN_INLINE int
ZYAN_STRCMP(const char * s1, const char * s2) {
    while (*s1 && (*s1 == *s2)) {
        s1++, s2++;
    }
...
ZYAN_INLINE int
ZYAN_STRCOLL(const char * s1, const char * s2) {
    ZYAN_UNUSED(s1);
    ZYAN_UNUSED(s2);
    return 0;
}
...
ZYAN_INLINE char *
ZYAN_STRCPY(char * dest, const char * src) {
    char * ret = dest;
    while ((*dest++ = *src++))
        ;
    return ret;
...
ZYAN_INLINE ZyanUSize
ZYAN_STRCSPN(const char * s1, const char * s2) {
    ZyanUSize ret = 0;
    while (*s1) {
...
ZYAN_INLINE char *
ZYAN_STRNCAT(char * dest, const char * src, ZyanUSize n) {
    char * ret = dest;
    while (*dest) {
        dest++;
    }
...
ZYAN_INLINE int
ZYAN_STRNCMP(const char * s1, const char * s2, ZyanUSize n) {
    while (n--) {
        if (*s1++ != *s2++) {
...
ZYAN_INLINE char *
ZYAN_STRNCPY(char * dest, const char * src, ZyanUSize n) {
    char * ret = dest;
    do {
        if (!n--) {
            return ret;
...
ZYAN_INLINE char *
ZYAN_STRPBRK(const char * s1, const char * s2) {
    while (*s1) {
        if (ZYAN_STRCHR(s2, *s1++)) {
            return (char *)--s1;
        }
...
ZYAN_INLINE char *
ZYAN_STRRCHR(const char * s, int c) {
    char * ret = 0;
    do {
        if (*s == (char)c) {
            ret = (char *)s;
...
ZYAN_INLINE ZyanUSize
ZYAN_STRSPN(const char * s1, const char * s2) {
    ZyanUSize ret = 0;
...
ZYAN_INLINE char *
ZYAN_STRSTR(const char * s1, const char * s2) {
...
ZYAN_INLINE char *
ZYAN_STRTOK(char * str, const char * delim) {
    static char * p = 0;
    if (str) {
        p = str;
    } else if (!p) {
...
ZYAN_INLINE ZyanUSize
ZYAN_STRXFRM(char * dest, const char * src, ZyanUSize n) {
