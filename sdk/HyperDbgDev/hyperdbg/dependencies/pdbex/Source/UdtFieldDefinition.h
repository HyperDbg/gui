...
public:
  ...
  void VisitBaseType(const SYMBOL *Symbol) override {
    ...
    //
    // If this returns null, it probably means BasicTypeMapMSVC and/or
    // BasicTypeMapStdInt are out of date compared to MS DIA. Output the
    // (non-compilable) type "<unknown_type>" instead of crashing.
    //
