...
// This header file provides access to Win32, plus NTSTATUS values and some
// access mask values.
...
#ifndef __cplusplus
// This is needed to workaround C17 preprocessor errors when using legacy
// versions of the Windows SDK. (dmex)
