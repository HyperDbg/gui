...
typedef enum _TOKEN_INFORMATION_CLASS {
  ...
  TokenAuditPolicy,           // q; s: TOKEN_AUDIT_POLICY (requires
  ...
  TokenLinkedToken,           // q; s: TOKEN_LINKED_TOKEN (requires
  ...
  TokenMandatoryPolicy,       // q; s: TOKEN_MANDATORY_POLICY (requires
                              // SeTcbPrivilege)
  ...
  TokenRestrictedUserClaimAttributes,   // q:
                                        // CLAIM_SECURITY_ATTRIBUTES_INFORMATION
  TokenRestrictedDeviceClaimAttributes, // q:
                                        // CLAIM_SECURITY_ATTRIBUTES_INFORMATION
  TokenDeviceGroups,                    // q: TOKEN_GROUPS
  TokenRestrictedDeviceGroups,          // q: TOKEN_GROUPS
  TokenSecurityAttributes,              // q; s:
                           // TOKEN_SECURITY_ATTRIBUTES_[AND_OPERATION_]INFORMATION
  ...
  TokenIsAppSilo,                    // TokenOriginatingProcessTrustLevel // q:
...
NTSTATUS
NTAPI
NtCreateLowBoxToken(_Out_ PHANDLE TokenHandle, _In_ HANDLE ExistingTokenHandle,
