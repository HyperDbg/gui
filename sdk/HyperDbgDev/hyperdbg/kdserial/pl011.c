...
BOOLEAN
PL011InitializePort(_In_opt_ _Null_terminated_ PCHAR LoadOptions,
...
BOOLEAN
SBSAInitializePort(_In_opt_ _Null_terminated_ PCHAR LoadOptions,
                   _Inout_ PCPPORT Port, BOOLEAN MemoryMapped, UCHAR AccessSize,
                   UCHAR BitWidth)
...
BOOLEAN
SBSA32InitializePort(_In_opt_ _Null_terminated_ PCHAR LoadOptions,
                     _Inout_ PCPPORT Port, BOOLEAN MemoryMapped,
                     UCHAR AccessSize, UCHAR BitWidth)
...
BOOLEAN
PL011SetBaud(_Inout_ PCPPORT Port, ULONG Rate)
...
UART_STATUS
PL011GetByte(_Inout_ PCPPORT Port, _Out_ PUCHAR Byte)
...
UART_STATUS
PL011PutByte(_Inout_ PCPPORT Port, UCHAR Byte, BOOLEAN BusyWait)
...
BOOLEAN
PL011RxReady(_Inout_ PCPPORT Port)
