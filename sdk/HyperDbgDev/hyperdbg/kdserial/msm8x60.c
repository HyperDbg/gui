...
BOOLEAN
MSM8x60SetBaud(_Inout_ PCPPORT Port, ULONG Rate);

// ------------------------------------------------------------------ Functions

BOOLEAN
MSM8x60InitializePort(_In_opt_ _Null_terminated_ PCHAR LoadOptions,
...
UART_STATUS
MSM8x60GetByte(_Inout_ PCPPORT Port, _Out_ PUCHAR Byte)
...
UART_STATUS
MSM8x60PutByte(_Inout_ PCPPORT Port, UCHAR Byte, BOOLEAN BusyWait)
...
BOOLEAN
MSM8x60RxReady(_Inout_ PCPPORT Port)
