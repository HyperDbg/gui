...
BOOLEAN
MX6InitializePort(_In_opt_ _Null_terminated_ PCHAR LoadOptions,
...
BOOLEAN
MX6SetBaud(_Inout_ PCPPORT Port, ULONG Rate)
...
UART_STATUS
MX6GetByte(_Inout_ PCPPORT Port, _Out_ PUCHAR Byte)
...
UART_STATUS
MX6PutByte(_Inout_ PCPPORT Port, UCHAR Byte, BOOLEAN BusyWait)
...
BOOLEAN
MX6RxReady(_Inout_ PCPPORT Port)
