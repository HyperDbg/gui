...
/**
 * @brief Show information about different sections of PE and the dump of
 * sections
 * @param AddressOfFile
 * @param SectionToShow
 * @param Is32Bit
...
PeShowSectionInformationAndDump(const WCHAR *AddressOfFile,
                                const CHAR *SectionToShow, BOOLEAN Is32Bit) {
  int i = 0;
  ...
  OpHeader32; // Optional Header of PE files present in NT Header structure
  IMAGE_OPTIONAL_HEADER64
  OpHeader64; // Optional Header of PE files present in NT Header structure
