...
VOID CommandSearchMemoryHelp() {
  ...
  ShowMessages("syntax : \tsb [StartAddress (hex)] [l Length (hex)] "
               "[BytePattern (hex)] [pid ProcessId (hex)]\n");
  ShowMessages("syntax : \tsd [StartAddress (hex)] [l Length (hex)] "
               "[BytePattern (hex)] [pid ProcessId (hex)]\n");
  ShowMessages("syntax : \tsq [StartAddress (hex)] [l Length (hex)] "
               "[BytePattern (hex)] [pid ProcessId (hex)]\n");
