  ...
  if (SplittedCommand.size() == 1) {
    ...
    if (!SplittedCommand.at(1).compare("list")) {
      ...
      if (ScriptEngineGetFieldOffsetWrapper((CHAR *)"nt!_EPROCESS",
        ...
        AddressOfActiveProcessHead); ShowMessages("Offset Of ActiveProcessLinks
        : 0x%x\n", OffsetOfActiveProcessLinks); ShowMessages("Offset Of
        ImageFileName : 0x%x\n", OffsetOfImageFileName); ShowMessages("Offset Of
