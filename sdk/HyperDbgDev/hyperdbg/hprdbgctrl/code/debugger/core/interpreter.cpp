...
int HyperDbgInterpreter(char *Command) {
  ...
  if (Iterator == g_CommandsList.end()) {
    ...
    vector<string> CaseSensitiveSplittedCommand{
    ...
    if (HelpCommand) {
      ...
      if ((Iterator->second.CommandAttrib &
        ...
        string CaseSensitiveCommandString(Command);
        Iterator->second.CommandFunction(SplittedCommand,
 ...
 * return false
 */
bool HyperDbgCheckMultilineCommand(std::string &CurrentCommand, bool Reset) {
  if (Reset) {
    ...
    case '\\':
      ...
      if (g_IsInterpreterPreviousCharacterABackSlash)
        g_IsInterpreterPreviousCharacterABackSlash =
            FALSE; // it's not a escape character (two backslashes \\ )
      else
 ...
 * should be ignored
 */
bool HyperDbgContinuePreviousCommand() {
...
VOID InitializeCommandsDictionary() {
  ...
  g_CommandsList["clear"] = {&CommandClearScreen, &CommandClearScreenHelp,
                             DEBUGGER_COMMAND_CLEAR_ATTRIBUTES};
  g_CommandsList[".cls"] = {&CommandClearScreen, &CommandClearScreenHelp,
                            DEBUGGER_COMMAND_CLEAR_ATTRIBUTES};
  g_CommandsList["cls"] = {&CommandClearScreen, &CommandClearScreenHelp,
                           DEBUGGER_COMMAND_CLEAR_ATTRIBUTES};
  ...
  g_CommandsList["bh"] = {&CommandEptHook, &CommandEptHookHelp,
                          DEBUGGER_COMMAND_EPTHOOK_ATTRIBUTES};
