...
BOOLEAN
CommandSettingsGetValueFromConfigFile(std::string OptionName,
                                      std::string &OptionValue);
...
UINT32
HyperDbgLengthDisassemblerEngine(unsigned char *BufferToDisassemble,
...
VOID CommandCrwrite(vector<string> SplittedCommand, string Command);
...
VOID CommandStart(vector<string> SplittedCommand, string Command);

VOID CommandRestart(vector<string> SplittedCommand, string Command);

VOID CommandSwitch(vector<string> SplittedCommand, string Command);
...
VOID CommandThread(vector<string> SplittedCommand, string Command);

VOID CommandEval(vector<string> SplittedCommand, string Command);

VOID CommandR(vector<string> SplittedCommand, string Command);

VOID CommandBp(vector<string> SplittedCommand, string Command);
...
VOID CommandSym(vector<string> SplittedCommand, string Command);
...
VOID CommandK(vector<string> SplittedCommand, string Command);

VOID CommandPe(vector<string> SplittedCommand, string Command);
