 ...
 * @brief Functions relating to Exception Bitmap and Event (Interrupt and
 * Exception) Injection
 * @details
 * @version 0.1
 * @date 2020-04-11
 ...
 * @return VOID
 */
VOID EventInjectUndefinedOpcode(UINT32 CurrentProcessorIndex) {
  EventInjectInterruption(INTERRUPT_TYPE_HARDWARE_EXCEPTION,
...
VOID EventInjectPageFault(UINT64 PageFaultAddress) {
  ...
  //
  EventInjectInterruption(INTERRUPT_TYPE_HARDWARE_EXCEPTION,
                          EXCEPTION_VECTOR_PAGE_FAULT, TRUE, ErrorCode.Flags);
}
