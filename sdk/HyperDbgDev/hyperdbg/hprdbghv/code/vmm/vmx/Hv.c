...
HvSetGuestSelector(PVOID GdtBase, ULONG SegmentRegister, UINT16 Selector) {
  ...
  __vmx_vmwrite(VMCS_GUEST_ES_LIMIT + SegmentRegister * 2,
...
VOID HvHandleControlRegisterAccess(PGUEST_REGS GuestState,
  ...
  RegPtr =
      (UINT64 *)&GuestState->rax + CrExitQualification->GeneralPurposeRegister;
  ...
  */
  ...
  case VMX_EXIT_QUALIFICATION_ACCESS_MOV_TO_CR: {
    ...
    case VMX_EXIT_QUALIFICATION_REGISTER_CR0:
      ...
      DebuggerTriggerEvents(CONTROL_REGISTER_MODIFIED, GuestState,
                            VMX_EXIT_QUALIFICATION_REGISTER_CR0);
      break;
    case VMX_EXIT_QUALIFICATION_REGISTER_CR3:
      ...
      //
      if (CurrentVmState->DebuggingState.ThreadOrProcessTracingDetails
      ...
      if (g_CheckPageFaultsAndMov2Cr3VmexitsWithUserDebugger) {
        AttachingHandleCr3VmexitsForThreadInterception(ProcessorIndex,
                                                       NewCr3Reg);
      }
    ...
    case VMX_EXIT_QUALIFICATION_REGISTER_CR4:
      ...
      DebuggerTriggerEvents(CONTROL_REGISTER_MODIFIED, GuestState,
                            VMX_EXIT_QUALIFICATION_REGISTER_CR4);
      break;
    default:
      LogWarning(
 ...
 * @return VOID
 */
VOID HvFillGuestSelectorData(PVOID GdtBase, ULONG SegmentRegister,
                             UINT16 Selector) {
  VMX_SEGMENT_SELECTOR SegmentSelector = {0};
...
/**
 * @brief Add the current instruction length to guest rip to resume to next
 * instruction
 *
 * @return VOID
 */
 ...
 * @return VOID
 */
VOID HvSetMovToCr3Vmexit(BOOLEAN Set) { ProtectedHvSetMov2Cr3Exiting(Set); }
 ...
 * @return VOID
 */
VOID HvHandleMovDebugRegister(UINT32 ProcessorIndex, PGUEST_REGS Regs) {
 ...
 * @return VOID
 */
VOID HvSetExceptionBitmap(UINT32 IdtIndex) {
  //
 ...
 * @return VOID
 */
VOID HvUnsetExceptionBitmap(UINT32 IdtIndex) {
  //
  // This is a wrapper to perform extra checks
  //
 ...
 * @return VOID
 */
VOID HvSetExternalInterruptExiting(BOOLEAN Set) {
  //
  // This is a wrapper to perform extra checks
  //
 ...
 * @return VOID
 */
VOID HvSetRdtscExiting(BOOLEAN Set) { ProtectedHvSetRdtscExiting(Set); }
 ...
 * @return VOID
 */
VOID HvSetMovDebugRegsExiting(BOOLEAN Set) {
