 ...
 * @details This file does not contain all the MSRs, instead it contains general
 *MSRs that used in this projec, some other MSRs e.g., EPT related MSRs are in
 *their specific headers
 *
