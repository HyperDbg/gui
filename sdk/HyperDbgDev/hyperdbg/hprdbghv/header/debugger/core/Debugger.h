...
typedef struct _DEBUGGER_CORE_EVENTS {
  ...
  //
  LIST_ENTRY
  HiddenHookReadAndWriteEventsHead;    // HIDDEN_HOOK_READ_AND_WRITE  [WARNING
                                       // : MAKE SURE TO INITIALIZE LIST HEAD ,
                                       // Add it to DebuggerRegisterEvent, Add
                                       // it to DebuggerTriggerEvents, Add
                                       // termination to DebuggerTerminateEvent
                                       // ]
  LIST_ENTRY HiddenHookReadEventsHead; // HIDDEN_HOOK_READ  [WARNING : MAKE SURE
                                       // TO INITIALIZE LIST HEAD , Add it to
                                       // DebuggerRegisterEvent, Add it to
                                       // DebuggerTriggerEvents, Add termination
                                       // to DebuggerTerminateEvent ]
  LIST_ENTRY
  HiddenHookWriteEventsHead; // HIDDEN_HOOK_WRITE  [WARNING : MAKE SURE TO
                             // INITIALIZE LIST HEAD , Add it to
                             // DebuggerRegisterEvent, Add it to
                             // DebuggerTriggerEvents, Add termination to
                             // DebuggerTerminateEvent ]
  LIST_ENTRY
  EptHook2sExecDetourEventsHead; // HIDDEN_HOOK_EXEC_DETOURS [WARNING : MAKE
                                 // SURE TO INITIALIZE LIST HEAD , Add it to
                                 // DebuggerRegisterEvent, Add it to
                                 // DebuggerTriggerEvents, Add termination
                                 // to DebuggerTerminateEvent ]
  LIST_ENTRY EptHookExecCcEventsHead; // HIDDEN_HOOK_EXEC_CC [WARNING : MAKE
                                      // SURE TO INITIALIZE LIST HEAD , Add it
                                      // to DebuggerRegisterEvent, Add it to
                                      // DebuggerTriggerEvents, Add termination
                                      // to DebuggerTerminateEvent ]
  LIST_ENTRY
  SyscallHooksEferSyscallEventsHead; // SYSCALL_HOOK_EFER_SYSCALL [WARNING :
                                     // MAKE SURE TO INITIALIZE LIST HEAD ,
                                     // Add it to DebuggerRegisterEvent, Add
                                     // it to DebuggerTriggerEvents, Add
                                     // termination to
                                     // DebuggerTerminateEvent ]
  LIST_ENTRY
  SyscallHooksEferSysretEventsHead; // SYSCALL_HOOK_EFER_SYSRET [WARNING :
                                    // MAKE SURE TO INITIALIZE LIST HEAD ,
                                    // Add it to DebuggerRegisterEvent, Add
                                    // it to DebuggerTriggerEvents, Add
                                    // termination to DebuggerTerminateEvent
                                    // ]
  LIST_ENTRY
  CpuidInstructionExecutionEventsHead; // CPUID_INSTRUCTION_EXECUTION
                                       // [WARNING : MAKE SURE TO INITIALIZE
                                       // LIST HEAD , Add it to
                                       // DebuggerRegisterEvent, Add it to
                                       // DebuggerTriggerEvents, Add
                                       // termination to
                                       // DebuggerTerminateEvent ]
  LIST_ENTRY
  RdmsrInstructionExecutionEventsHead; // RDMSR_INSTRUCTION_EXECUTION
                                       // [WARNING : MAKE SURE TO INITIALIZE
                                       // LIST HEAD , Add it to
                                       // DebuggerRegisterEvent, Add it to
                                       // DebuggerTriggerEvents, Add
                                       ...
                                       // DebuggerTerminateEvent ]
  LIST_ENTRY
  WrmsrInstructionExecutionEventsHead; // WRMSR_INSTRUCTION_EXECUTION
                                       // [WARNING : MAKE SURE TO INITIALIZE
                                       // LIST HEAD , Add it to
                                       // DebuggerRegisterEvent, Add it to
                                       // DebuggerTriggerEvents, Add
                                       ...
                                       // DebuggerTerminateEvent ]
  LIST_ENTRY
  ExceptionOccurredEventsHead; // EXCEPTION_OCCURRED [WARNING : MAKE SURE TO
                               // INITIALIZE LIST HEAD , Add it to
                               // DebuggerRegisterEvent, Add it to
                               // DebuggerTriggerEvents, Add termination to
                               // DebuggerTerminateEvent ]
  LIST_ENTRY
  TscInstructionExecutionEventsHead; // TSC_INSTRUCTION_EXECUTION [WARNING :
                                     // MAKE SURE TO INITIALIZE LIST HEAD ,
                                     // Add it to DebuggerRegisterEvent, Add
                                     // it to DebuggerTriggerEvents, Add
                                     // termination to
                                     // DebuggerTerminateEvent ]
  LIST_ENTRY
  PmcInstructionExecutionEventsHead; // PMC_INSTRUCTION_EXECUTION [WARNING :
                                     // MAKE SURE TO INITIALIZE LIST HEAD ,
                                     // Add it to DebuggerRegisterEvent, Add
                                     // it to DebuggerTriggerEvents, Add
                                     // termination to
                                     // DebuggerTerminateEvent ]
  LIST_ENTRY
  InInstructionExecutionEventsHead; // IN_INSTRUCTION_EXECUTION [WARNING :
                                    // MAKE SURE TO INITIALIZE LIST HEAD ,
                                    // Add it to DebuggerRegisterEvent, Add
                                    // it to DebuggerTriggerEvents, Add
                                    // termination to DebuggerTerminateEvent
                                    // ]
  LIST_ENTRY
  OutInstructionExecutionEventsHead; // OUT_INSTRUCTION_EXECUTION [WARNING :
                                     // MAKE SURE TO INITIALIZE LIST HEAD ,
                                     // Add it to DebuggerRegisterEvent, Add
                                     // it to DebuggerTriggerEvents, Add
                                     // termination to
                                     // DebuggerTerminateEvent ]
  LIST_ENTRY
  DebugRegistersAccessedEventsHead; // DEBUG_REGISTERS_ACCESSED [WARNING :
                                    // MAKE SURE TO INITIALIZE LIST HEAD ,
                                    // Add it to DebuggerRegisterEvent, Add
                                    // it to DebuggerTriggerEvents, Add
                                    // termination to DebuggerTerminateEvent
                                    // ]
  LIST_ENTRY
  ExternalInterruptOccurredEventsHead; // EXTERNAL_INTERRUPT_OCCURRED
                                       // [WARNING : MAKE SURE TO INITIALIZE
                                       // LIST HEAD , Add it to
                                       // DebuggerRegisterEvent, Add it to
                                       // DebuggerTriggerEvents, Add
                                       ...
                                       // DebuggerTerminateEvent ]
  LIST_ENTRY
  VmcallInstructionExecutionEventsHead; // VMCALL_INSTRUCTION_EXECUTION
                                        ...
                                        // DebuggerTerminateEvent ]
  LIST_ENTRY
  ControlRegisterModifiedEventsHead; // CONTROL_REGISTER_MODIFIED [WARNING :
                                     // MAKE SURE TO INITIALIZE LIST HEAD ,
                                     // Add it to DebuggerRegisterEvent, Add
                                     // it to DebuggerTriggerEvents, Add
                                     // termination to
 ...
 * @details Each logical processor contains one of this structure which
 * describes about the state of debuggers, flags, etc.
 *
 */
 ...
 *
 * @param PreAllocatedBufferAddress The address of a pre-allocated non-paged
 * pool if the user-requested for it
 * @param Regs Guest registers
 * @param Context Optional parameter which is different
 * for each event and shows a unique description about
 * the event
