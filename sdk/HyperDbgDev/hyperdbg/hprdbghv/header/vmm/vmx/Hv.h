 ...
 * @brief This file contains the headers for Hypervisor Routines which have to
 * be called by external codes
 ...
 * @return VOID
 */
VOID HvSetMovToCr3Vmexit(BOOLEAN Set);
 ...
 * @return VOID
 */
VOID HvSetRdtscExiting(BOOLEAN Set);
