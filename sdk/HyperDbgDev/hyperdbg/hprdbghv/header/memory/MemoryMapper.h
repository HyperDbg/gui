 ...
 * @brief This file shows the header functions to map memory to reserved system
 * ranges
 *
...
MemoryMapperWriteMemorySafeOnTargetProcess(_Inout_ UINT64 Destination,
                                           _In_ PVOID Source, _In_ SIZE_T Size);

BOOLEAN
MemoryMapperWriteMemorySafe(_Inout_ UINT64 Destination, _In_ PVOID Source,
                            _In_ SIZE_T SizeToWrite,
                            _In_ CR3_TYPE TargetProcessCr3);

PPAGE_ENTRY
MemoryMapperGetPteVa(_In_ PVOID Va, _In_ PAGING_LEVEL Level);

PPAGE_ENTRY
MemoryMapperGetPteVaByCr3(_In_ PVOID Va, _In_ PAGING_LEVEL Level,
                          _In_ CR3_TYPE TargetCr3);
...
BOOLEAN
MemoryMapperCheckIfPageIsPresentByCr3(_In_ PVOID Va, _In_ CR3_TYPE TargetCr3);
...
BOOLEAN
MemoryMapperWriteMemoryUnsafe(_Inout_ UINT64 Destination, _In_ PVOID Source,
                              _In_ SIZE_T SizeToWrite,
