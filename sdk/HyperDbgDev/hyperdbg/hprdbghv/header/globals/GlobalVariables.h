 ...
 * @brief Here we put global variables that are used more or less in all part of
 * our hypervisor (not all of them)
...
/**
 * @brief Save the state of the thread that waits for messages to deliver to
 * user-mode
 *
 */
...
/**
 * @brief Determines whether the clients are allowed to send IOCTL to the drive
 * or not
 *
 */
