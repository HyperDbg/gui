...
GetValue(PGUEST_REGS GuestRegs, PACTION_BUFFER ActionBuffer,
         PSCRIPT_ENGINE_VARIABLES_LIST VariablesList, PSYMBOL Symbol,
  ...
  case SYMBOL_PSEUDO_REG_TYPE:
    ...
    if (ReturnReference)
      return NULL; // Not reasonable, you should not dereference a
                   // pseudo-register!
    else
...
BOOL ScriptEngineExecute(PGUEST_REGS GuestRegs, ACTION_BUFFER *ActionDetail,
                         ...
                         SYMBOL_BUFFER *CodeBuffer, int *Indx,
  ...
  *Indx = *Indx + 1;
  ...
  case FUNC_ED:
    ...
    *Indx = *Indx + 1;
    ...
    SrcVal0 = GetValue(GuestRegs, ActionDetail, VariablesList, Src0, FALSE);
    ...
    *Indx = *Indx + 1;
    ...
    SrcVal1 = GetValue(GuestRegs, ActionDetail, VariablesList, Src1, FALSE);
  ...
  case FUNC_INTERLOCKED_COMPARE_EXCHANGE:
    ...
    *Indx = *Indx + 1;
    ...
    SrcVal2 = GetValue(GuestRegs, ActionDetail, VariablesList, Src2, FALSE);
  ...
  case FUNC_PAUSE:
    ...
    ScriptEngineFunctionPause(ActionDetail->Tag,
                              ...
                              GuestRegs, ActionDetail->Context);
    return HasError;
  ...
  case FUNC_POI:
    ...
    *Indx = *Indx + 1;
    ...
    DesVal = ScriptEngineKeywordPoi(
        (PUINT64)GetValue(GuestRegs, ActionDetail, VariablesList, Src0, FALSE),
        &HasError);
    SetValue(GuestRegs, VariablesList, Des, DesVal);
  ...
  case FUNC_PHYSICAL_TO_VIRTUAL:
    ...
    *Indx = *Indx + 1;
    ...
    DesVal = ScriptEngineFunctionPhysicalToVirtual(
  ...
  case FUNC_VIRTUAL_TO_PHYSICAL:
    ...
    *Indx = *Indx + 1;
    ...
    DesVal = ScriptEngineFunctionVirtualToPhysical(
        GetValue(GuestRegs, ActionDetail, VariablesList, Src0, FALSE));
  ...
  case FUNC_PRINTF:
    ...
    *Indx = *Indx + 1;
    ...
    ScriptEngineFunctionPrintf(
        GuestRegs, ActionDetail, VariablesList, ActionDetail->Tag,
