...
int main() {
  ...
  /*
      ...
      Local var @ 0x95fa18df58 Type
   AllocateStructForCasting::__l2::_STUPID_STRUCT2* 0x00000260`d065ee30

         +0x000 Sina32           : 0x32
         +0x008 Sina64           : 0x64
         +0x010 AghaaSina        : 0x00000000`00000055 Void
         +0x018 UnicodeStr       : 0x00000260`d065ec70
   AllocateStructForCasting::__l2::_UNICODE_STRING +0x000 Length           :
   0x40 +0x002 MaximumLength    : 0x40 +0x008 Buffer           :
   0x00000260`d065ecf0  "Goodbye I'm at stupid struct 2!" +0x020 StupidStruct1
   : 0x00000260`d065eda0 AllocateStructForCasting::__l2::_STUPID_STRUCT1 +0x000
   Flag32           : 0x3232 +0x008 Flag64           : 0x6464 +0x010 Context :
   0x00000000`00000085 Void +0x018 StringValue      : 0x00000260`d065eb50
   AllocateStructForCasting::__l2::_UNICODE_STRING +0x000 Length           :
   0x3c +0x002 MaximumLength    : 0x3c +0x008 Buffer           :
   0x00000260`d065ebd0  "Hi come from stupid struct 1!"
