...
VOID SetGuestIdtr(UINT64 Idtr) { __vmx_vmwrite(VMCS_GUEST_IDTR_BASE, Idtr); }
UINT64
GetGuestIdtr() {
  UINT64 Idtr;
...
VOID SetGuestLdtr(UINT64 Ldtr) { __vmx_vmwrite(VMCS_GUEST_LDTR_BASE, Ldtr); }
UINT64
GetGuestLdtr() {
  UINT64 Ldtr;
...
VOID SetGuestGdtr(UINT64 Gdtr) { __vmx_vmwrite(VMCS_GUEST_GDTR_BASE, Gdtr); }
UINT64
GetGuestGdtr() {
  UINT64 Gdtr;
...
VOID SetGuestTr(UINT64 Tr) { __vmx_vmwrite(VMCS_GUEST_TR_BASE, Tr); }
UINT64
GetGuestTr() {
  UINT64 Tr;
...
VOID SetGuestRFlags(UINT64 RFlags) { __vmx_vmwrite(VMCS_GUEST_RFLAGS, RFlags); }
UINT64
GetGuestRFlags() {
  UINT64 RFlags;
...
VOID SetGuestRIP(UINT64 RIP) { __vmx_vmwrite(VMCS_GUEST_RIP, RIP); }
VOID SetGuestRSP(UINT64 RSP) { __vmx_vmwrite(VMCS_GUEST_RSP, RSP); }
UINT64
GetGuestRIP() {
  UINT64 RIP;
...
VOID SetGuestCr0(UINT64 Cr0) { __vmx_vmwrite(VMCS_GUEST_CR0, Cr0); }
VOID SetGuestCr2(UINT64 Cr2) { __writecr2(Cr2); }
VOID SetGuestCr3(UINT64 Cr3) { __vmx_vmwrite(VMCS_GUEST_CR3, Cr3); }
VOID SetGuestCr4(UINT64 Cr4) { __vmx_vmwrite(VMCS_GUEST_CR4, Cr4); }
