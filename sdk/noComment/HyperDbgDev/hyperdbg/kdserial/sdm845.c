...
BOOLEAN
SDM845SetBaud(_Inout_ PCPPORT Port, ULONG Rate);
BOOLEAN
SDM845ReinitializePort(_Inout_ PCPPORT Port)
{
  ULONG ConfigMask;
  ULONG Retries;
  Retries = 0;
...
BOOLEAN
SDM845InitializePort(_In_opt_ _Null_terminated_ PCHAR LoadOptions,
...
UART_STATUS
SDM845GetByte(_Inout_ PCPPORT Port, _Out_ PUCHAR Byte)
{
  ULONG AvailableBytes;
  PUCHAR BaseAddress;
  ULONG IrqStatus;
...
UART_STATUS
SDM845PutByte(_Inout_ PCPPORT Port, UCHAR Byte, BOOLEAN BusyWait)
{
  PUCHAR Address;
  if ((Port == NULL) || (Port->Address == NULL)) {
    return UartNotReady;
...
BOOLEAN
SDM845RxReady(_Inout_ PCPPORT Port)
{
  PUCHAR BaseAddress;
  ULONG FifoStatReg;
  ULONG PartialBytesToRead;
