...
#define LDR_DATA_TABLE_ENTRY_SIZE_WINXP_32                                     \
  FIELD_OFFSET(LDR_DATA_TABLE_ENTRY32, DdagNode)
#define LDR_DATA_TABLE_ENTRY_SIZE_WIN7_32                                      \
  FIELD_OFFSET(LDR_DATA_TABLE_ENTRY32, BaseNameHashValue)
#define LDR_DATA_TABLE_ENTRY_SIZE_WIN8_32                                      \
...
typedef struct _PEB32 {
  ...
  WOW64_POINTER(PVOID) TelemetryCoverageHeader; 
