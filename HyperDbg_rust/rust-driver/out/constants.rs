...
pub const IMAGE_POLICY_SECTION_NAME: &::core::ffi::CStr = c".tPolicy";
...
pub const TRANSACTIONMANAGER_OBJECT_PATH: &::core::ffi::CStr = c"\\TransactionManager\\";
pub const TRANSACTION_OBJECT_PATH: &::core::ffi::CStr = c"\\Transaction\\";
pub const ENLISTMENT_OBJECT_PATH: &::core::ffi::CStr = c"\\Enlistment\\";
pub const RESOURCE_MANAGER_OBJECT_PATH: &::core::ffi::CStr = c"\\ResourceManager\\";
...
pub const EA_CONTAINER_NAME: &::core::ffi::CStr = c"ContainerName";
pub const EA_CONTAINER_SIZE: &::core::ffi::CStr = c"ContainerSize";
pub const CLFS_BASELOG_EXTENSION: &::core::ffi::CStr = c".blf";
...
pub const CLFS_CONTAINER_STREAM_PREFIX: &::core::ffi::CStr = c"%BLF%:";
pub const CLFS_CONTAINER_RELATIVE_PREFIX: &::core::ffi::CStr = c"%BLF%\\";
...
pub const ACCESS_DS_SOURCE_A: &::core::ffi::CStr = c"DS";
pub const ACCESS_DS_SOURCE_W: &::core::ffi::CStr = c"DS";
pub const ACCESS_DS_OBJECT_TYPE_NAME_A: &::core::ffi::CStr = c"Directory Service Object";
pub const ACCESS_DS_OBJECT_TYPE_NAME_W: &::core::ffi::CStr = c"Directory Service Object";
...
pub const RTL_SYSTEM_VOLUME_INFORMATION_FOLDER: &::core::ffi::CStr = c"System Volume Information";
pub const PSMP_MINIMUM_SYSAPP_CLAIM_VALUES: u32 = 2;
pub const PSMP_MAXIMUM_SYSAPP_CLAIM_VALUES: u32 = 4;
pub const MSV1_0_PACKAGE_NAME: &::core::ffi::CStr = c"MICROSOFT_AUTHENTICATION_PACKAGE_V1_0";
pub const MSV1_0_PACKAGE_NAMEW: &::core::ffi::CStr = c"MICROSOFT_AUTHENTICATION_PACKAGE_V1_0";
pub const MSV1_0_SUBAUTHENTICATION_KEY: &::core::ffi::CStr = c"SYSTEM\\CurrentControlSet\\Control\\Lsa\\MSV1_0";
pub const MSV1_0_SUBAUTHENTICATION_VALUE: &::core::ffi::CStr = c"Auth";
...
pub const FSCTL_REFS_VOLUME_ATTESTATION_MAX_SIGNING_HASH_SIZE: u32 = 64;
pub const IO_QOS_MAX_RESERVATION: u32 = 1000000000;
pub const SMB_CCF_APP_INSTANCE_EA_NAME: &::core::ffi::CStr = c"ClusteredApplicationInstance";
pub const NETWORK_APP_INSTANCE_CSV_FLAGS_VALID_ONLY_IF_CSV_COORDINATOR: u32 = 1;
pub const LX_FILE_METADATA_UID_EA_NAME: &::core::ffi::CStr = c"$LXUID";
pub const LX_FILE_METADATA_GID_EA_NAME: &::core::ffi::CStr = c"$LXGID";
pub const LX_FILE_METADATA_MODE_EA_NAME: &::core::ffi::CStr = c"$LXMOD";
pub const LX_FILE_METADATA_DEVICE_ID_EA_NAME: &::core::ffi::CStr = c"$LXDEV";
...
pub const OBJECT_CLOSE_RESULT_VERSION_V1: u32 = 1;
pub const OBJECT_CLOSE_RESULT_CURRENT_VERSION: u32 = 1;
...
pub const OPLOCK_FSCTRL_FLAG_NON_CACHED_OPEN_PRESENT: u32 = 4;
...
pub const DD_MUP_DEVICE_NAME: &::core::ffi::CStr = c"\\Device\\Mup";
pub const EA_NAME_NETWORK_OPEN_ECP_PRIVACY: &::core::ffi::CStr = c"ECP{c584edbf-00df-4d28-00b8-8435baca8911e8}-PRIVACY";
pub const EA_NAME_NETWORK_OPEN_ECP_PRIVACY_U: &::core::ffi::CStr = c"ECP{c584edbf-00df-4d28-00b8-8435baca8911e8}-PRIVACY";
pub const EA_NAME_NETWORK_OPEN_ECP_INTEGRITY: &::core::ffi::CStr = c"ECP{c584edbf-00df-4d28-00b8-8435baca8911e8}-INTEGRITY";
pub const EA_NAME_NETWORK_OPEN_ECP_INTEGRITY_U: &::core::ffi::CStr = c"ECP{c584edbf-00df-4d28-00b8-8435baca8911e8}-INTEGRITY";
...
pub const EOF: i32 = -1;
pub const _P_tmpdir: &::core::ffi::CStr = c"\\";
pub const _wP_tmpdir: &::core::ffi::CStr = c"\\";
...
pub const P_tmpdir: &::core::ffi::CStr = c"\\";
...
pub const __WARNING_WRITE_OVERRUN: u32 = 6386;
...
unsafe extern "C" {
    pub static GUID_PROCESSOR_FREQUENCY_MINIMUM: GUID;
}
unsafe extern "C" {
    pub static GUID_PROCESSOR_FREQUENCY_MINIMUM_1: GUID;
}
unsafe extern "C" {
    pub static GUID_PROCESSOR_FREQUENCY_MINIMUM_2: GUID;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub static GUID_PROCESSOR_PACKAGE_C6_POLICY: GUID;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub static GUID_PROCESSOR_PERF_LATENCY_HINT_FREQ: GUID;
}
unsafe extern "C" {
    pub static GUID_PROCESSOR_PERF_LATENCY_HINT_FREQ_1: GUID;
}
unsafe extern "C" {
    pub static GUID_PROCESSOR_PERF_LATENCY_HINT_FREQ_2: GUID;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub static CXL_PROTOCOL_ERROR_SECTION_GUID: GUID;
}
unsafe extern "C" {
    pub static CXL_COMPONENT_EVENTS_SECTION_DRAM_EVENT_RECORD_GUID: GUID;
}
unsafe extern "C" {
    pub static CXL_COMPONENT_EVENTS_SECTION_MEMORY_MODULE_EVENT_RECORD_GUID: GUID;
}
unsafe extern "C" {
    pub static WHEA_MEMORY_RANGE_ERROR_SECTION_GUID: GUID;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub static PLATFORM_EXTENDED_RAS_SECTION_GUID: GUID;
}
unsafe extern "C" {
    pub static MEMORY_ERROR_EXT_SECTION_AMD_GUID: GUID;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub static AMD_NORMALIZED_TO_DRAM_PRM_HANDLER_GUID: GUID;
}
unsafe extern "C" {
    pub static AMD_DRAM_TO_NORMALIZED_PRM_HANDLER_GUID: GUID;
}
unsafe extern "C" {
    pub static AMD_NORMALIZED_TO_SPA_PRM_HANDLER_GUID: GUID;
}
unsafe extern "C" {
    pub static AMD_SPA_TO_NORMALIZED_PRM_HANDLER_GUID: GUID;
}
unsafe extern "C" {
    pub static AMD_SPA_TO_DRAM_PRM_HANDLER_GUID: GUID;
}
unsafe extern "C" {
    pub static AMD_DRAM_TO_SPA_PRM_HANDLER_GUID: GUID;
}
unsafe extern "C" {
