...
type Anon870_5 struct {
	Raw [1]int64
}
type Anon874_9 struct {
	Pcid            Uint64
...
type Anon1996_9 struct {
	Raw [1]int32
}
type Anon1998_5 struct {
...
func init() {
	...
	gengort.Validate((*Anon870_5)(nil), 0x8, 0x8)
	gengort.Validate((*Anon874_9)(nil), 0x8, 0x8, "Pcid", 0xc, "PageFrameNumber", 0x30, "Reserved1", 0x3c, "Reserved_2", 0x3f, "PcidInvalidate", 0x40)
	...
	gengort.Validate((*EptSingleHookUnhookingDetails)(nil), 0x10, 0x8, "CallerNeedsToRestoreEntryAndInvalidateEpt", 0x0, "RemoveBreakpointInterception", 0x1, "PhysicalAddress", 0x4, "OriginalEntry", 0x8)
	gengort.Validate((*Anon1996_9)(nil), 0x4, 0x4)
	gengort.Validate((*Anon1998_5)(nil), 0x4, 0x4, "Type", 0x4, "DescriptorType", 0x5, "DescriptorPrivilegeLevel", 0x7, "Present", 0x8, "Reserved1", 0xc, "AvailableBit", 0xd, "LongMode", 0xe, "DefaultBig", 0xf, "Granularity", 0x10, "Unusable", 0x11, "Reserved2", 0x20)
