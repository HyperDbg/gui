...
REGULAR_INSTANT_EVENT_CONDITIONAL_BUFFER=sizeof(DEBUGGER_EVENT) + 100
BIG_INSTANT_EVENT_CONDITIONAL_BUFFER=sizeof(DEBUGGER_EVENT) + PAGE_SIZE
REGULAR_INSTANT_EVENT_ACTION_BUFFER=sizeof(DEBUGGER_EVENT_ACTION) + (PAGE_SIZE * 2)
BIG_INSTANT_EVENT_ACTION_BUFFER=sizeof(DEBUGGER_EVENT_ACTION) + MaxSerialPacketSize
...
OPERATION_LOG_INFO_MESSAGE=1U
OPERATION_LOG_WARNING_MESSAGE=2U
...
SIZEOF_DEBUGGER_MODIFY_EVENTS=sizeof(DEBUGGER_MODIFY_EVENTS)
