...
var (
	...
	LogBufferSize                                                                                      = MaximumPacketsCapacity * (PacketChunkSize + 128)
	LogBufferSizePriority                                                                              = MaximumPacketsCapacityPriority * (PacketChunkSize + 128)
	...
	REGULAR_INSTANT_EVENT_CONDITIONAL_BUFFER                                                           = 128 + 100
	BIG_INSTANT_EVENT_CONDITIONAL_BUFFER                                                               = 128 + PAGE_SIZE
	REGULAR_INSTANT_EVENT_ACTION_BUFFER                                                                = 128 + (PAGE_SIZE * 2)
	BIG_INSTANT_EVENT_ACTION_BUFFER                                                                    = 128 + MaxSerialPacketSize
	...
	SIZEOF_DEBUGGER_PAUSE_PACKET_RECEIVED                                                              = 128
	...
	SIZEOF_DEBUGGER_MODIFY_EVENTS                                                                      = 128
	SIZEOF_REGISTER_EVENT                                                                              = 128
