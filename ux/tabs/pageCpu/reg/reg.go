...
func (o *object) CanvasObject(window *unison.Window) *unison.Panel {
	...
	scrollPanel := unison.NewScrollPanel()
	scrollPanel.SetContent(panel, unison.FillBehavior, unison.FillBehavior)
	scrollPanel.SetLayoutData(&unison.FlexLayoutData{
		HAlign: unison.FillAlignment,
		VAlign: unison.FillAlignment,
		HGrab:  true,
		VGrab:  true,
	})
	scrollPanel.SetSizer(func(_ unison.Size) (min, pref, max unison.Size) {
		pref.Width = 220
		pref.Height = 220
