				...
				Certificates: []Certificate{
					{
						Info: CertInfo{
							...
							NotBefore:          time.Date(2018, time.November, 13, 0o0, 0o0, 0, 0, time.UTC),
				...
				Certificates: []Certificate{
					{
						Info: CertInfo{
							...
							NotBefore:          time.Date(2016, time.December, 16, 0o0, 0o0, 0, 0, time.UTC),
					...
					},
					{
						Info: CertInfo{
							...
							Subject:            "US, California, Mountain View, Symantec Corporation, Symantec Corporation",
							NotBefore:          time.Date(2017, time.March, 15, 0o0, 0o0, 0, 0, time.UTC),
