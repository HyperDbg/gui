...
type KdState struct {
	...
	resultOfRegisteringEvent    types.DEBUGGER_EVENT_AND_ACTION_RESULT
	resultOfAddingActionsTo     types.DEBUGGER_EVENT_AND_ACTION_RESULT
...
func (k *KdState) KdPrepareDebuggee(ctx context.Context, portAddress, baudrate, kernelBase uint32, osName string) error {
	...
	var req types.DEBUGGER_PREPARE_DEBUGGEE
	...
	var resp types.DEBUGGER_PREPARE_DEBUGGEE
...
func (k *KdState) KdSendUserInterfacePausePacket(ctx context.Context) error {
	...
	var pkt types.DEBUGGER_PAUSE_PACKET_RECEIVED
...
func (k *KdState) KdRegisterEventInDebuggee(ctx context.Context, eventBuf []byte) (types.DEBUGGER_EVENT_AND_ACTION_RESULT, error) {
	k.mu.Lock()
	dev := k.device
	k.mu.Unlock()
	if dev == nil {
		return types.DEBUGGER_EVENT_AND_ACTION_RESULT{}, fmt.Errorf("KdRegisterEventInDebuggee: no device")
	}
	...
	if err := k.KdSendGeneralBuffersFromDebuggeeToDebugger(
		ctx,
		types.DebuggerRemotePacketRequestedActionDebuggeeResultOfRegisteringEvent,
		resultBuf,
		true,
	); err != nil {
...
func (k *KdState) KdAddActionToEventInDebuggee(ctx context.Context, actionBuf []byte) (types.DEBUGGER_EVENT_AND_ACTION_RESULT, error) {
	k.mu.Lock()
	dev := k.device
	k.mu.Unlock()
	if dev == nil {
		return types.DEBUGGER_EVENT_AND_ACTION_RESULT{}, fmt.Errorf("KdAddActionToEventInDebuggee: no device")
	}
	var result types.DEBUGGER_EVENT_AND_ACTION_RESULT
	resultBuf := structAsBytes(unsafe.Pointer(&result), unsafe.Sizeof(result))
	...
	if err := k.KdSendGeneralBuffersFromDebuggeeToDebugger(
		ctx,
		types.DebuggerRemotePacketRequestedActionDebuggeeResultOfAddingActionToEvent,
		resultBuf,
		true,
	); err != nil {
...
func (k *KdState) KdSendModifyEventInDebuggee(ctx context.Context, modify *types.DEBUGGER_MODIFY_EVENTS, sendResultToDebugger bool) error {
	k.mu.Lock()
	dev := k.device
	k.mu.Unlock()
	if dev == nil {
	...
	if sendResultToDebugger {
		if err := k.KdSendGeneralBuffersFromDebuggeeToDebugger(
			ctx,
			types.DebuggerRemotePacketRequestedActionDebuggeeResultOfQueryAndModifyEvent,
			outBuf,
			true,
		); err != nil {
...
func (k *KdState) KdSendSignalExecutionFinished(ctx context.Context) error {
	...
	var sig types.DEBUGGER_SEND_COMMAND_EXECUTION_FINISHED_SIGNAL
...
func (k *KdState) KdSendUsermodePrints(ctx context.Context, msg []byte) error {
	...
	hdrSize := unsafe.Sizeof(types.DEBUGGER_SEND_USERMODE_MESSAGES_TO_DEBUGGER{})
...
func (k *KdState) KdSendGeneralBuffersFromDebuggeeToDebugger(
	ctx context.Context,
	action types.DEBUGGER_REMOTE_PACKET_REQUESTED_ACTION,
	buf []byte,
	...
	hdrSize := unsafe.Sizeof(types.DEBUGGEE_SEND_GENERAL_PACKET_FROM_DEBUGGEE_TO_DEBUGGER{})
...
func (k *KdState) KdCommandGoto(ctx context.Context) error {
	...
	if err := k.KdCommandPacketToDebuggee(
		types.DebuggerRemotePacketTypeDebuggerToDebuggeeExecuteOnVmxRoot,
		types.DebuggerRemotePacketRequestedActionOnVmxRootModeContinue,
	); err != nil {
		return err
	}
...
func (k *KdState) KdCommandStep(ctx context.Context, stepType types.DEBUGGER_REMOTE_STEPPING_REQUEST, isCall bool, callInstrSize uint32) error {
	k.mu.Lock()
	t := k.transport
	k.mu.Unlock()
	if t == nil {
	...
	var pkt types.DEBUGGEE_STEP_PACKET
	...
	k.mu.Lock()
	switch stepType {
	case types.DebuggerRemoteSteppingRequestStepIn,
		types.DebuggerRemoteSteppingRequestStepOver,
		types.DebuggerRemoteSteppingRequestStepOverForGu:
		k.isDebuggeeRunning = true
	}
	k.mu.Unlock()
	if err := k.KdCommandPacketAndBufferToDebuggee(
		types.DebuggerRemotePacketTypeDebuggerToDebuggeeExecuteOnVmxRoot,
		types.DebuggerRemotePacketRequestedActionOnVmxRootModeStep,
		buf,
	); err != nil {
		return err
	}
...
func (k *KdState) KdCommandPause(ctx context.Context) error {
	if err := k.KdCommandPacketToDebuggee(
		types.DebuggerRemotePacketTypeDebuggerToDebuggeeExecuteOnUserMode,
		types.DebuggerRemotePacketRequestedActionOnUserModePause,
	); err != nil {
		return err
	}
	...
	if isDebuggee {
		...
		if t != nil {
			_ = k.KdCommandPacketToDebuggee(
				types.DebuggerRemotePacketTypeDebuggerToDebuggeeExecuteOnVmxRoot,
				types.DebuggerRemotePacketRequestedActionOnVmxRootModeCloseAndUnloadDebuggee,
			)
			k.printf("unloading debugger vmm module on debuggee...")
			_ = k.KdCommandPacketToDebuggee(
				types.DebuggerRemotePacketTypeDebuggerToDebuggeeExecuteOnUserMode,
				types.DebuggerRemotePacketRequestedActionOnUserModeDoNotReadAnyPacket,
			)
		}
	} else {
...
func (k *KdState) KdCommandPacketToDebuggee(
	packetType types.DEBUGGER_REMOTE_PACKET_TYPE,
	action types.DEBUGGER_REMOTE_PACKET_REQUESTED_ACTION,
) error {
	var pkt types.DEBUGGER_REMOTE_PACKET
...
func (k *KdState) KdCommandPacketAndBufferToDebuggee(
	...
	pktSize := unsafe.Sizeof(types.DEBUGGER_REMOTE_PACKET{})
...
func (k *KdState) KdSendBpPacket(ctx context.Context, bp *types.DEBUGGEE_BP_PACKET) error {
	buf := structAsBytes(unsafe.Pointer(bp), unsafe.Sizeof(*bp))
	if err := k.KdCommandPacketAndBufferToDebuggee(
		types.DebuggerRemotePacketTypeDebuggerToDebuggeeExecuteOnVmxRoot,
		types.DebuggerRemotePacketRequestedActionOnVmxRootBp,
		buf,
	); err != nil {
		return err
	}
...
func (k *KdState) KdSendListOrModifyBpPacket(ctx context.Context, pkt *types.DEBUGGEE_BP_LIST_OR_MODIFY_PACKET) error {
	buf := structAsBytes(unsafe.Pointer(pkt), unsafe.Sizeof(*pkt))
	if err := k.KdCommandPacketAndBufferToDebuggee(
		types.DebuggerRemotePacketTypeDebuggerToDebuggeeExecuteOnVmxRoot,
		types.DebuggerRemotePacketRequestedActionOnVmxRootListOrModifyBreakpoints,
		buf,
	); err != nil {
		return err
	}
...
func (k *KdState) KdSendFlushPacket(ctx context.Context) error {
	...
	if err := k.KdCommandPacketAndBufferToDebuggee(
		types.DebuggerRemotePacketTypeDebuggerToDebuggeeExecuteOnVmxRoot,
		types.DebuggerRemotePacketRequestedActionOnVmxRootModeFlushBuffers,
		buf,
	); err != nil {
		return err
	}
...
func (k *KdState) KdSendSwitchCorePacket(ctx context.Context, newCore uint32) error {
	...
	if err := k.KdCommandPacketAndBufferToDebuggee(
		types.DebuggerRemotePacketTypeDebuggerToDebuggeeExecuteOnVmxRoot,
		types.DebuggerRemotePacketRequestedActionOnVmxRootModeChangeCore,
		buf,
	); err != nil {
		return err
	}
...
func (k *KdState) KdSendShortCircuitingEvent(ctx context.Context, isEnabled bool) error {
	...
	if err := k.KdCommandPacketAndBufferToDebuggee(
		types.DebuggerRemotePacketTypeDebuggerToDebuggeeExecuteOnVmxRoot,
		types.DebuggerRemotePacketRequestedActionOnVmxRootSetShortCircuitingState,
		buf,
	); err != nil {
		return err
	}
...
func (k *KdState) KdSendEventQueryAndModifyPacket(
	ctx context.Context,
	tag uint64,
	actionType types.DEBUGGER_MODIFY_EVENTS_TYPE,
) (bool, error) {
	k.mu.Lock()
	...
	if err := k.KdCommandPacketAndBufferToDebuggee(
		types.DebuggerRemotePacketTypeDebuggerToDebuggeeExecuteOnVmxRoot,
		types.DebuggerRemotePacketRequestedActionOnVmxRootQueryAndModifyEvent,
		buf,
	); err != nil {
		return false, err
	}
	...
	k.mu.Lock()
	defer k.mu.Unlock()
	if actionType == types.DebuggerModifyEventsQueryState {
...
func (k *KdState) KdSendUserInputPacket(ctx context.Context, input string, ignoreBreakingAgain bool) error {
	var hdr types.DEBUGGEE_USER_INPUT_PACKET
	...
	if err := k.KdCommandPacketAndBufferToDebuggee(
		types.DebuggerRemotePacketTypeDebuggerToDebuggeeExecuteOnVmxRoot,
		types.DebuggerRemotePacketRequestedActionOnVmxRootUserInputBuffer,
		buf,
	); err != nil {
		return err
	}
...
func (k *KdState) KdSendScriptPacket(ctx context.Context, scriptBuf []byte, pointer uint32, isFormat bool) error {
	var hdr types.DEBUGGEE_SCRIPT_PACKET
	...
	if err := k.KdCommandPacketAndBufferToDebuggee(
		types.DebuggerRemotePacketTypeDebuggerToDebuggeeExecuteOnVmxRoot,
		types.DebuggerRemotePacketRequestedActionOnVmxRootRunScript,
		buf,
	); err != nil {
		return err
	}
...
func (k *KdState) KdSendSymbolReloadPacket(ctx context.Context, processId uint32) error {
	var pkt types.DEBUGGEE_SYMBOL_REQUEST_PACKET
	pkt.ProcessId = processId
	buf := structAsBytes(unsafe.Pointer(&pkt), unsafe.Sizeof(pkt))
	if err := k.KdCommandPacketAndBufferToDebuggee(
		types.DebuggerRemotePacketTypeDebuggerToDebuggeeExecuteOnVmxRoot,
		types.DebuggerRemotePacketRequestedActionOnVmxRootSymbolReload,
		buf,
	); err != nil {
		return err
	}
...
func (k *KdState) SetResultOfRegisteringEvent(r types.DEBUGGER_EVENT_AND_ACTION_RESULT) {
	k.mu.Lock()
	defer k.mu.Unlock()
...
func (k *KdState) ResultOfRegisteringEvent() types.DEBUGGER_EVENT_AND_ACTION_RESULT {
	k.mu.Lock()
	defer k.mu.Unlock()
...
// action. Called by the listener.
func (k *KdState) SetResultOfAddingActions(r types.DEBUGGER_EVENT_AND_ACTION_RESULT) {
	k.mu.Lock()
	defer k.mu.Unlock()
...
func (k *KdState) ResultOfAddingActions() types.DEBUGGER_EVENT_AND_ACTION_RESULT {
	k.mu.Lock()
	defer k.mu.Unlock()
...
func (k *KdState) KdSendResponseOfThePingPacket(ctx context.Context) error {
	...
	if err := k.KdCommandPacketAndBufferToDebuggee(
		types.DebuggerRemotePacketTypeDebuggerToDebuggeeExecuteOnUserMode,
		types.DebuggerRemotePacketRequestedActionOnUserModeDebuggerVersion,
		sig,
	); err != nil {
