...
func fromPausingReason(r types.DEBUGGEE_PAUSING_REASON) KernelEvent {
	switch r {
	case types.DebuggeePausingReasonPause:
		return KernelEventPaused
	case types.DebuggeePausingReasonRequestFromDebugger:
		return KernelEventRequestFromDebugger
	case types.DebuggeePausingReasonDebuggeeStepped:
		return KernelEventSingleStep
	case types.DebuggeePausingReasonDebuggeeTrackingStepped:
		return KernelEventTrackingStep
	case types.DebuggeePausingReasonDebuggeeSoftwareBreakpointHit:
		return KernelEventBreakpointHit
	case types.DebuggeePausingReasonDebuggeeHardwareDebugRegisterHit:
		return KernelEventHardwareDebugRegisterHit
	case types.DebuggeePausingReasonDebuggeeCoreSwitched:
		return KernelEventCoreSwitched
	case types.DebuggeePausingReasonDebuggeeProcessSwitched:
		return KernelEventProcessSwitched
	case types.DebuggeePausingReasonDebuggeeThreadSwitched:
		return KernelEventThreadSwitched
	case types.DebuggeePausingReasonDebuggeeCommandExecutionFinished:
		return KernelEventCommandFinished
	case types.DebuggeePausingReasonDebuggeeEventTriggered:
		return KernelEventTriggered
	case types.DebuggeePausingReasonDebuggeeStartingModuleLoaded:
		return KernelEventStartingModuleLoaded
	case types.DebuggeePausingReasonDebuggeeGeneralDebugBreak:
		return KernelEventGeneralDebugBreak
	case types.DebuggeePausingReasonDebuggeeGeneralThreadIntercepted:
		return KernelEventGeneralThreadIntercepted
	case types.DebuggeePausingReasonHardwareBasedDebuggeeGeneralBreak:
...
type KernelPausedPacket struct {
	Header  types.DEBUGGER_REMOTE_PACKET
	Payload []byte
}
...
type KernelHandler func(ctx context.Context, state *KdState, ev KernelEvent, pkt types.DEBUGGEE_KD_PAUSED_PACKET) error
...
func (l *KernelListener) dispatch(ctx context.Context, p KernelPausedPacket) error {
	...
	if p.Header.TypeOfThePacket != types.DebuggerRemotePacketTypeDebuggeeToDebugger {
		l.printf("err, unknown packet received from the debuggee\n")
		return nil
	}

	switch p.Header.RequestedActionOfThePacket {
	case types.DebuggerRemotePacketPingAndSendSupportedVersion:
		if err := l.state.KdSendResponseOfThePingPacket(ctx); err != nil {
			l.printf("err, failed to send ping response: %v\n", err)
		}

	case types.DebuggerRemotePacketRequestedActionDebuggeeStarted:
		l.handleDebuggeeStarted(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeLoggingMechanism:
		l.handleLoggingMechanism(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeePausedAndCurrentInstruction:
		return l.handlePausedAndCurrentInstruction(ctx, p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfChangingCore:
		l.handleChangeCoreResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfChangingProcess:
		l.handleChangeProcessResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfChangingThread:
		l.handleChangeThreadResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeReloadSearchQuery:
		l.handleSearchQueryResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfFlush:
	...
	// it, add a `case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfUserCpuid:
	...
	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfCallstack:
		l.handleCallstackResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultTestQuery:
		l.handleTestQueryResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfRunningScript:
		l.handleScriptResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfFormats:
		l.handleFormatsResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfRegisteringEvent:
		l.handleRegisterEventResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfAddingActionToEvent:
		l.handleAddActionResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfQueryAndModifyEvent:
		l.handleQueryAndModifyEventResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeReloadSymbolFinished:
		l.handleSymbolReloadFinished(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfReadingRegisters:
		l.handleReadRegistersResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfWriteRegister:
		l.handleWriteRegisterResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfApicRequests:
		l.handleCallerBufferResult(p, SyncObjectApicActions)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfQueryIdtEntriesRequests:
		l.handleCallerBufferResult(p, SyncObjectIdtEntries)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfReadingMemory:
		l.handleCallerBufferResult(p, SyncObjectReadMemory)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfEditingMemory:
		l.handleCallerBufferResult(p, SyncObjectEditMemory)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfBp:
		l.handleBpResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfShortCircuitingState:
		l.handleShortCircuitingResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfPte:
		l.handlePteResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultSmiOperationRequests:
		l.handleCallerBufferResult(p, SyncObjectSmiOperationResult)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultHypertraceLbrOperationRequests:
		l.handleCallerBufferResult(p, SyncObjectHypertraceLbrDumpResult)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultHypertracePtOperationRequests:
		l.handleCallerBufferResult(p, SyncObjectHypertracePtOperationResult)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfBringingPagesIn:
		l.handlePageInResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfVa2paAndPa2va:
		l.handleVa2paPa2vaResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfListOrModifyBreakpoints:
		l.handleListOrModifyBpResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeUpdateSymbolInfo:
	...
	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfPcitree:
		l.handlePcitreeResult(p)

	case types.DebuggerRemotePacketRequestedActionDebuggeeResultOfPcidevinfo:
...
func (l *KernelListener) handleDebuggeeStarted(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGER_PREPARE_DEBUGGEE{})) {
		l.printf("err, debuggee-started packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectStartedPacketReceived)
		return
	}
	var init types.DEBUGGER_PREPARE_DEBUGGEE
...
func (l *KernelListener) handleLoggingMechanism(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGEE_MESSAGE_PACKET{})) {
		l.printf("err, logging-mechanism packet too small\n")
		return
	}
	var msg types.DEBUGGEE_MESSAGE_PACKET
...
func (l *KernelListener) handlePausedAndCurrentInstruction(ctx context.Context, p KernelPausedPacket) error {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGEE_KD_PAUSED_PACKET{})) {
		l.printf("err, paused packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectIsDebuggerRunning)
		return nil
	}
	var pkt types.DEBUGGEE_KD_PAUSED_PACKET
	...
	case KernelEventTriggered:
		if pkt.EventTag != 0 {
			if pkt.EventCallingStage == types.VmmCallbackCallingStagePostEventEmulation {
...
func (l *KernelListener) handleChangeCoreResult(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGEE_CHANGE_CORE_PACKET{})) {
		l.printf("err, change-core packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectCoreSwitchingResult)
		return
	}
	var pkt types.DEBUGGEE_CHANGE_CORE_PACKET
	bytesIntoStruct(unsafe.Pointer(&pkt), p.Payload, unsafe.Sizeof(pkt))
...
func (l *KernelListener) handleChangeProcessResult(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGEE_DETAILS_AND_SWITCH_PROCESS_PACKET{})) {
		l.printf("err, change-process packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectProcessSwitchingResult)
		return
	}
	var pkt types.DEBUGGEE_DETAILS_AND_SWITCH_PROCESS_PACKET
	bytesIntoStruct(unsafe.Pointer(&pkt), p.Payload, unsafe.Sizeof(pkt))
	if pkt.Result == DebuggerOperationWasSuccessful {
		switch pkt.ActionType {
		case types.DebuggeeDetailsAndSwitchProcessGetProcessDetails:
			l.printf("process id: %x\nprocess (_EPROCESS): %s\nprocess name (16-Byte): %s\n",
				pkt.ProcessId,
				separateTo64BitValue(pkt.Process),
				uint8String(pkt.ProcessName[:]))
		case types.DebuggeeDetailsAndSwitchProcessPerformSwitch:
...
func (l *KernelListener) handleChangeThreadResult(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGEE_DETAILS_AND_SWITCH_THREAD_PACKET{})) {
		l.printf("err, change-thread packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectThreadSwitchingResult)
		return
	}
	var pkt types.DEBUGGEE_DETAILS_AND_SWITCH_THREAD_PACKET
	bytesIntoStruct(unsafe.Pointer(&pkt), p.Payload, unsafe.Sizeof(pkt))
	if pkt.Result == DebuggerOperationWasSuccessful {
		switch pkt.ActionType {
		case types.DebuggeeDetailsAndSwitchThreadGetThreadDetails:
			l.printf("thread id: %x (pid: %x)\nthread (_ETHREAD): %s\nprocess (_EPROCESS): %s\nprocess name (16-Byte): %s\n",
				pkt.ThreadId, pkt.ProcessId,
				separateTo64BitValue(pkt.Thread),
				separateTo64BitValue(pkt.Process),
				uint8String(pkt.ProcessName[:]))
		case types.DebuggeeDetailsAndSwitchThreadPerformSwitch:
...
func (l *KernelListener) handleSearchQueryResult(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGEE_RESULT_OF_SEARCH_PACKET{})) {
		l.printf("err, search-query packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectSearchQueryResult)
		return
	}
	var pkt types.DEBUGGEE_RESULT_OF_SEARCH_PACKET
	bytesIntoStruct(unsafe.Pointer(&pkt), p.Payload, unsafe.Sizeof(pkt))
	if pkt.Result == DebuggerOperationWasSuccessful {
...
func (l *KernelListener) handleFlushResult(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGER_FLUSH_LOGGING_BUFFERS{})) {
		l.printf("err, flush packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectFlushResult)
		return
	}
	var pkt types.DEBUGGER_FLUSH_LOGGING_BUFFERS
	bytesIntoStruct(unsafe.Pointer(&pkt), p.Payload, unsafe.Sizeof(pkt))
...
func (l *KernelListener) handleCallstackResult(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGER_CALLSTACK_REQUEST{})) {
		l.printf("err, callstack packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectCallstackResult)
		return
	}
	var pkt types.DEBUGGER_CALLSTACK_REQUEST
	bytesIntoStruct(unsafe.Pointer(&pkt), p.Payload, unsafe.Sizeof(pkt))
	if pkt.KernelStatus != DebuggerOperationWasSuccessful {
...
func (l *KernelListener) handleScriptResult(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGEE_SCRIPT_PACKET{})) {
		l.printf("err, script-result packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectScriptRunningResult)
		return
	}
	var pkt types.DEBUGGEE_SCRIPT_PACKET
	bytesIntoStruct(unsafe.Pointer(&pkt), p.Payload, unsafe.Sizeof(pkt))
	if pkt.Result != DebuggerOperationWasSuccessful {
...
func (l *KernelListener) handleFormatsResult(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGEE_FORMATS_PACKET{})) {
		l.printf("err, formats packet too small\n")
		return
	}
	var pkt types.DEBUGGEE_FORMATS_PACKET
	bytesIntoStruct(unsafe.Pointer(&pkt), p.Payload, unsafe.Sizeof(pkt))
...
func (l *KernelListener) handleRegisterEventResult(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGER_EVENT_AND_ACTION_RESULT{})) {
		l.printf("err, register-event packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectRegisterEvent)
		return
	}
	var pkt types.DEBUGGER_EVENT_AND_ACTION_RESULT
	bytesIntoStruct(unsafe.Pointer(&pkt), p.Payload, unsafe.Sizeof(pkt))
...
func (l *KernelListener) handleQueryAndModifyEventResult(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGER_MODIFY_EVENTS{})) {
		l.printf("err, query-modify-event packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectModifyAndQueryEvent)
		return
	}
	var pkt types.DEBUGGER_MODIFY_EVENTS
	bytesIntoStruct(unsafe.Pointer(&pkt), p.Payload, unsafe.Sizeof(pkt))
	...
	} else if pkt.TypeOfAction == types.DebuggerModifyEventsQueryState {
...
func (l *KernelListener) handleSymbolReloadFinished(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGEE_SYMBOL_UPDATE_RESULT{})) {
		l.printf("err, symbol-reload packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectSymbolReload)
		return
	}
	var pkt types.DEBUGGEE_SYMBOL_UPDATE_RESULT
	bytesIntoStruct(unsafe.Pointer(&pkt), p.Payload, unsafe.Sizeof(pkt))
	if pkt.KernelStatus != uint64(DebuggerOperationWasSuccessful) {
...
func (l *KernelListener) handleBpResult(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGEE_BP_PACKET{})) {
		l.printf("err, bp-result packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectBp)
		return
	}
	var pkt types.DEBUGGEE_BP_PACKET
	bytesIntoStruct(unsafe.Pointer(&pkt), p.Payload, unsafe.Sizeof(pkt))
	if pkt.Result != DebuggerOperationWasSuccessful {
...
func (l *KernelListener) handleShortCircuitingResult(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGER_SHORT_CIRCUITING_EVENT{})) {
		l.printf("err, short-circuiting packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectShortCircuitingEventState)
		return
	}
	var pkt types.DEBUGGER_SHORT_CIRCUITING_EVENT
	bytesIntoStruct(unsafe.Pointer(&pkt), p.Payload, unsafe.Sizeof(pkt))
	if pkt.KernelStatus == uint64(DebuggerOperationWasSuccessful) {
		state := "'off'"
...
func (l *KernelListener) handlePteResult(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGER_READ_PAGE_TABLE_ENTRIES_DETAILS{})) {
		l.printf("err, pte packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectPteResult)
		return
	}
	var pkt types.DEBUGGER_READ_PAGE_TABLE_ENTRIES_DETAILS
	bytesIntoStruct(unsafe.Pointer(&pkt), p.Payload, unsafe.Sizeof(pkt))
	if pkt.KernelStatus != DebuggerOperationWasSuccessful {
...
func (l *KernelListener) handlePageInResult(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGER_PAGE_IN_REQUEST{})) {
		l.printf("err, page-in packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectPageInState)
		return
	}
	var pkt types.DEBUGGER_PAGE_IN_REQUEST
	bytesIntoStruct(unsafe.Pointer(&pkt), p.Payload, unsafe.Sizeof(pkt))
	if pkt.KernelStatus == DebuggerOperationWasSuccessful {
...
func (l *KernelListener) handleVa2paPa2vaResult(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGER_VA2PA_AND_PA2VA_COMMANDS{})) {
		l.printf("err, va2pa/pa2va packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectVa2paAndPa2vaResult)
		return
	}
	var pkt types.DEBUGGER_VA2PA_AND_PA2VA_COMMANDS
	bytesIntoStruct(unsafe.Pointer(&pkt), p.Payload, unsafe.Sizeof(pkt))
	if pkt.KernelStatus == DebuggerOperationWasSuccessful {
...
func (l *KernelListener) handleListOrModifyBpResult(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGEE_BP_LIST_OR_MODIFY_PACKET{})) {
		l.printf("err, list-modify-bp packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectListOrModifyBreakpoints)
		return
	}
	var pkt types.DEBUGGEE_BP_LIST_OR_MODIFY_PACKET
	bytesIntoStruct(unsafe.Pointer(&pkt), p.Payload, unsafe.Sizeof(pkt))
	if pkt.Result != DebuggerOperationWasSuccessful {
...
func (l *KernelListener) handlePcitreeResult(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGEE_PCITREE_REQUEST_RESPONSE_PACKET{})) {
		l.printf("err, pcitree packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectPcitreeResult)
		return
	}
	var pkt types.DEBUGGEE_PCITREE_REQUEST_RESPONSE_PACKET
	bytesIntoStruct(unsafe.Pointer(&pkt), p.Payload, unsafe.Sizeof(pkt))
	if pkt.KernelStatus != DebuggerOperationWasSuccessful {
...
func (l *KernelListener) handlePcidevinfoResult(p KernelPausedPacket) {
	if uint32(len(p.Payload)) < uint32(unsafe.Sizeof(types.DEBUGGEE_PCIDEVINFO_REQUEST_RESPONSE_PACKET{})) {
		l.printf("err, pcidevinfo packet too small\n")
		l.state.ReceivedKernelResponse(SyncObjectPcidevinfoResult)
		return
	}
	var pkt types.DEBUGGEE_PCIDEVINFO_REQUEST_RESPONSE_PACKET
	bytesIntoStruct(unsafe.Pointer(&pkt), p.Payload, unsafe.Sizeof(pkt))
	if pkt.KernelStatus != DebuggerOperationWasSuccessful {
...
func DefaultKernelHandler(out Output) KernelHandler {
	return func(ctx context.Context, state *KdState, ev KernelEvent, pkt types.DEBUGGEE_KD_PAUSED_PACKET) error {
		_ = ctx
		if out == nil {
			return nil
		}
