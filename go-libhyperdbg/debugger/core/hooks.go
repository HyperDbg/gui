...
func (d *Debugger) registerHookEvent(
	ctx context.Context,
	eventType types.VMM_EVENT_TYPE_ENUM,
	pid uint32,
...
func (d *Debugger) CpuidHook(ctx context.Context, hasEax bool, eax uint64, callbackSrc string) (uint64, error) {
	opts := types.DEBUGGER_EVENT_OPTIONS{OptionalParam1: 0}
	if hasEax {
		opts.OptionalParam1 = 1
		opts.OptionalParam2 = eax
	}
	return d.registerHookEvent(ctx, types.CpuidInstructionExecution,
...
func (d *Debugger) CrwriteHook(ctx context.Context, cr uint32, mask uint64, callbackSrc string) (uint64, error) {
	opts := types.DEBUGGER_EVENT_OPTIONS{
		OptionalParam1: uint64(cr),
		OptionalParam2: mask,
	}
	return d.registerHookEvent(ctx, types.ControlRegisterModified,
		debuggerEventApplyToAllProcesses, opts, callbackSrc)
}
...
func (d *Debugger) DrHook(ctx context.Context, callbackSrc string) (uint64, error) {
	return d.registerHookEvent(ctx, types.DebugRegistersAccessed,
		debuggerEventApplyToAllProcesses, types.DEBUGGER_EVENT_OPTIONS{}, callbackSrc)
}
...
func (d *Debugger) EptHook2(ctx context.Context, hookAddress uint64, pid uint32, callbackSrc string) (uint64, error) {
	opts := types.DEBUGGER_EVENT_OPTIONS{OptionalParam1: hookAddress}
	return d.registerHookEvent(ctx, types.HiddenHookExecDetours,
...
func (d *Debugger) ExceptionHook(ctx context.Context, vector uint32, callbackSrc string) (uint64, error) {
	opts := types.DEBUGGER_EVENT_OPTIONS{OptionalParam1: uint64(vector)}
	return d.registerHookEvent(ctx, types.ExceptionOccurred,
		debuggerEventApplyToAllProcesses, opts, callbackSrc)
}
...
func (d *Debugger) InterruptHook(ctx context.Context, vector uint32, callbackSrc string) (uint64, error) {
	opts := types.DEBUGGER_EVENT_OPTIONS{OptionalParam1: uint64(vector)}
	return d.registerHookEvent(ctx, types.ExternalInterruptOccurred,
		debuggerEventApplyToAllProcesses, opts, callbackSrc)
}
...
func (d *Debugger) IoInHook(ctx context.Context, port uint16, callbackSrc string) (uint64, error) {
	opts := types.DEBUGGER_EVENT_OPTIONS{OptionalParam1: uint64(port)}
	return d.registerHookEvent(ctx, types.InInstructionExecution,
		debuggerEventApplyToAllProcesses, opts, callbackSrc)
}
...
func (d *Debugger) IoOutHook(ctx context.Context, port uint16, callbackSrc string) (uint64, error) {
	opts := types.DEBUGGER_EVENT_OPTIONS{OptionalParam1: uint64(port)}
	return d.registerHookEvent(ctx, types.OutInstructionExecution,
		debuggerEventApplyToAllProcesses, opts, callbackSrc)
}
...
func (d *Debugger) ModeHook(ctx context.Context, mode types.DEBUGGER_EVENT_MODE_TYPE, pid uint32, callbackSrc string) (uint64, error) {
	opts := types.DEBUGGER_EVENT_OPTIONS{OptionalParam1: uint64(mode)}
	return d.registerHookEvent(ctx, types.TrapExecutionModeChanged,
		pid, opts, callbackSrc)
}
...
func (d *Debugger) MonitorWrite(ctx context.Context, addrStart, addrEnd uint64, pid uint32, callbackSrc string) (uint64, error) {
	...
	return d.registerHookEvent(ctx, types.HiddenHookWrite,
		pid, opts, callbackSrc)
}
...
func (d *Debugger) MonitorExec(ctx context.Context, addrStart, addrEnd uint64, pid uint32, callbackSrc string) (uint64, error) {
	...
	return d.registerHookEvent(ctx, types.HiddenHookExecute,
		pid, opts, callbackSrc)
}
...
func (d *Debugger) MsrReadHook(ctx context.Context, msr uint32, callbackSrc string) (uint64, error) {
	opts := types.DEBUGGER_EVENT_OPTIONS{OptionalParam1: uint64(msr)}
	return d.registerHookEvent(ctx, types.RdmsrInstructionExecution,
		debuggerEventApplyToAllProcesses, opts, callbackSrc)
}
...
func (d *Debugger) MsrWriteHook(ctx context.Context, msr uint32, callbackSrc string) (uint64, error) {
	opts := types.DEBUGGER_EVENT_OPTIONS{OptionalParam1: uint64(msr)}
	return d.registerHookEvent(ctx, types.WrmsrInstructionExecution,
		debuggerEventApplyToAllProcesses, opts, callbackSrc)
}
...
func (d *Debugger) SyscallHook(ctx context.Context, syscallNumber uint64, callbackSrc string) (uint64, error) {
	opts := types.DEBUGGER_EVENT_OPTIONS{
		...
		OptionalParam2: uint64(types.DebuggerEventSyscallSysretSafeAccessMemory),
	}
	return d.registerHookEvent(ctx, types.SyscallHookEferSyscall,
		debuggerEventApplyToAllProcesses, opts, callbackSrc)
}
...
func (d *Debugger) SysretHook(ctx context.Context, syscallNumber uint64, callbackSrc string) (uint64, error) {
	...
	return d.registerHookEvent(ctx, types.SyscallHookEferSysret,
		debuggerEventApplyToAllProcesses, opts, callbackSrc)
}
...
func (d *Debugger) VmcallHook(ctx context.Context, callbackSrc string) (uint64, error) {
	return d.registerHookEvent(ctx, types.VmcallInstructionExecution,
		debuggerEventApplyToAllProcesses, types.DEBUGGER_EVENT_OPTIONS{}, callbackSrc)
}
...
func (d *Debugger) XsetbvHook(ctx context.Context, callbackSrc string) (uint64, error) {
	return d.registerHookEvent(ctx, types.XsetbvInstructionExecution,
		debuggerEventApplyToAllProcesses, types.DEBUGGER_EVENT_OPTIONS{}, callbackSrc)
}
...
func (d *Debugger) TscHook(ctx context.Context, callbackSrc string) (uint64, error) {
	return d.registerHookEvent(ctx, types.TscInstructionExecution,
		debuggerEventApplyToAllProcesses, types.DEBUGGER_EVENT_OPTIONS{}, callbackSrc)
}
...
func (d *Debugger) PmcHook(ctx context.Context, callbackSrc string) (uint64, error) {
	return d.registerHookEvent(ctx, types.PmcInstructionExecution,
		debuggerEventApplyToAllProcesses, types.DEBUGGER_EVENT_OPTIONS{}, callbackSrc)
}
