...
type ReconstructMemoryMode = types.REVERSING_MACHINE_RECONSTRUCT_MEMORY_MODE

// ReconstructMemoryType mirrors REVERSING_MACHINE_RECONSTRUCT_MEMORY_TYPE.
type ReconstructMemoryType = types.REVERSING_MACHINE_RECONSTRUCT_MEMORY_TYPE
...
type ReconstructMemoryRequest = types.REVERSING_MACHINE_RECONSTRUCT_MEMORY_REQUEST
