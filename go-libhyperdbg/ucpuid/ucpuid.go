...
func (h *Handler) RequestCpuid(ctx context.Context, functionId, subFunctionId uint32) error {
	...
	var req types.DEBUGGER_CPUID_REQUEST_RESPONSE
...
// case.
func (h *Handler) ShowCpuidMessage(functionId, subFunctionId uint32, req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
	if req == nil {
...
func asBytes(req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) []byte {
...
func brandString(req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) string {
...
func (h *Handler) showLeafRaw(leaf uint32, title, body string, req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
	if title != "" {
...
func (h *Handler) showLeaf0(req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeaf1(req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeaf4(subFunctionId uint32, req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeaf5(req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeaf6(req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeaf7(subFunctionId uint32, req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeaf9(req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeafA(req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeafB(subFunctionId uint32, req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeafD(subFunctionId uint32, req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeaf10(subFunctionId uint32, req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeaf12(subFunctionId uint32, req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeaf14(subFunctionId uint32, req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeaf15(req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeaf16(req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeaf17(subFunctionId uint32, req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeaf18(subFunctionId uint32, req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeaf80000000(req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeaf80000001(req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeaf80000002to04(req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeaf80000006(req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeaf80000007(req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
...
func (h *Handler) showLeaf80000008(req *types.DEBUGGER_CPUID_REQUEST_RESPONSE) {
