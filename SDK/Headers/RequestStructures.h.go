...
var SIZEOF_DEBUGGER_DT_COMMAND_OPTIONS = binary.Size(DEBUGGER_DT_COMMAND_OPTIONS{})
...
var SIZEOF_DEBUGGER_READ_MEMORY = binary.Size(DEBUGGER_READ_MEMORY{})
...
var SIZEOF_DEBUGGER_TEST_QUERY_BUFFER = binary.Size(DEBUGGER_TEST_QUERY_BUFFER{})

type (
	DEBUGGER_TEST_QUERY_BUFFER struct {
		RequestIndex uint32
		KernelStatus uint32
	}
	PDEBUGGER_DEBUGGER_TEST_QUERY_BUFFER *DEBUGGER_TEST_QUERY_BUFFER
)
...
var SIZEOF_DEBUGGEE_SEND_GENERAL_PACKET_FROM_DEBUGGEE_TO_DEBUGGER = binary.Size(DEBUGGEE_SEND_GENERAL_PACKET_FROM_DEBUGGEE_TO_DEBUGGER{})
...
var SIZEOF_DEBUGGER_SEND_USERMODE_MESSAGES_TO_DEBUGGER = binary.Size(DEBUGGER_SEND_USERMODE_MESSAGES_TO_DEBUGGER{})
...
var SIZEOF_DEBUGGER_READ_AND_WRITE_ON_MSR = binary.Size(DEBUGGER_READ_AND_WRITE_ON_MSR{})
...
var SIZEOF_DEBUGGER_EDIT_MEMORY = binary.Size(DEBUGGER_EDIT_MEMORY{})
...
var SIZEOF_DEBUGGER_SEARCH_MEMORY = binary.Size(DEBUGGER_SEARCH_MEMORY{})
...
var SIZEOF_DEBUGGER_HIDE_AND_TRANSPARENT_DEBUGGER_MODE = binary.Size(DEBUGGER_HIDE_AND_TRANSPARENT_DEBUGGER_MODE{})
...
var SIZEOF_DEBUGGER_PREPARE_DEBUGGEE = binary.Size(DEBUGGER_PREPARE_DEBUGGEE{})
...
var SIZEOF_DEBUGGER_ATTACH_DETACH_USER_MODE_PROCESS = binary.Size(DEBUGGER_ATTACH_DETACH_USER_MODE_PROCESS{})
...
var SIZEOF_DEBUGGER_QUERY_ACTIVE_PROCESSES_OR_THREADS = binary.Size(DEBUGGER_QUERY_ACTIVE_PROCESSES_OR_THREADS{})
...
var SIZEOF_USERMODE_DEBUGGING_THREAD_OR_PROCESS_STATE_DETAILS = binary.Size(USERMODE_DEBUGGING_THREAD_OR_PROCESS_STATE_DETAILS{})
...
var SIZEOF_DEBUGGEE_DETAILS_AND_SWITCH_THREAD_PACKET = binary.Size(DEBUGGEE_DETAILS_AND_SWITCH_THREAD_PACKET{})
